...
class TeamAdmin(admin.ModelAdmin):
    ...
    def organization_link(self, team: Team):
        return format_html(
            '<a href="/admin/analytickit/organization/{}/change/">{}</a>', team.organization.pk, team.organization.name
        )
...
class UserAdmin(DjangoUserAdmin):
    ...
    fieldsets = (
        ...
        (_("AnalyticKit"), {"fields": ("temporary_token",)}),
    )
    ...
    def organization_name(self, user: User):
        ...
        return format_html(
            '<a href="/admin/analytickit/organization/{}/change/">{}</a>', user.organization.pk, user.organization.name
        )
...
class OrganizationTeamInline(admin.TabularInline):
    ...
    def displayed_name(self, team: Team):
        return format_html('<a href="/admin/analytickit/team/{}/change/">{}. {}</a>', team.pk, team.pk, team.name)
...
class OrganizationAdmin(admin.ModelAdmin):
    ...
    def first_member(self, organization: Organization):
        ...
        return format_html(f'<a href="/admin/analytickit/user/{user.pk}/change/">{user.email}</a>')
