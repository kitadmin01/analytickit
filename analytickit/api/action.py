...
from analytickit.auth import JwtAuthentication, PersonalAPIKeyAuthentication, TemporaryTokenAuthentication
from analytickit.client import sync_execute
from analytickit.constants import TREND_FILTER_TYPE_EVENTS
from analytickit.event_usage import report_user_action
from analytickit.models import Action, ActionStep, Filter, Person
...
class ActionViewSet(TaggedItemViewSetMixin, StructuredViewSetMixin, ForbidDestroyModel, viewsets.ModelViewSet):
    ...
    def list(self, request: request.Request, *args: Any, **kwargs: Any) -> Response:
        ...
        actions_list: List[Dict[Any, Any]] = self.serializer_class(actions, many=True,
                                                                   context={"request": request}).data  # type: ignore
