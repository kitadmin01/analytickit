...
from analytickit.models import Annotation, Team
...
class AnnotationsViewSet(StructuredViewSetMixin, ForbidDestroyModel, viewsets.ModelViewSet):
    """
    Create, Read, Update and Delete annotations. [See docs](https://analytickit.com/docs/user-guides/annotations) for more information on annotations.
    """
