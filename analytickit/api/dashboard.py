...
from analytickit.api.insight import InsightSerializer, InsightViewSet
...
from analytickit.constants import INSIGHT_TRENDS
from analytickit.event_usage import report_user_action
from analytickit.helpers import create_dashboard_from_template
from analytickit.models import Dashboard, DashboardTile, Insight, Team
...
class DashboardSerializer(TaggedItemSerializerMixin, serializers.ModelSerializer):
    ...
    def create(self, validated_data: Dict, *args: Any, **kwargs: Any) -> Dashboard:
        ...
        if use_template:
            ...
            try:
                from analytickit.api.insight import InsightSerializer
