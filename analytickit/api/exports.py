...
from analytickit.models import Insight
from analytickit.models.activity_logging.activity_log import Change, Detail, log_activity
from analytickit.models.exported_asset import ExportedAsset, get_content_response
...
class ExportedAssetSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data: Dict, *args: Any, **kwargs: Any) -> ExportedAsset:
        ...
        try:
            ...
            # regression test see https://github.com/AnalyticKit/analytickit/issues/11204
            pass
