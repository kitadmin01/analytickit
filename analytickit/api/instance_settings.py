...
from analytickit.models.instance_setting import get_instance_setting as get_instance_setting_raw
from analytickit.models.instance_setting import set_instance_setting as set_instance_setting_raw
...
class InstanceSettingsSerializer(serializers.Serializer):
    ...
    def update(self, instance: InstanceSettingHelper, validated_data: Dict[str, Any]) -> InstanceSettingHelper:
        ...
        if instance.key.startswith("EMAIL_") and "request" in self.context:
            from analytickit.tasks.email import send_canary_email
