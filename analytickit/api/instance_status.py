...
from analytickit.api.dashboard import DashboardSerializer
from analytickit.async_migrations.status import async_migrations_ok
from analytickit.gitsha import GIT_SHA
from analytickit.internal_metrics.team import get_internal_metrics_dashboards
from analytickit.permissions import OrganizationAdminAnyPermissions, SingleTenancyOrAdmin
...
class InstanceStatusViewSet(viewsets.ViewSet):
    ...
    def list(self, request: Request) -> Response:
        ...
        metrics.append({"key": "analytickit_version", "metric": "AnalyticKit version", "value": VERSION})

        metrics.append({"key": "analytickit_git_sha", "metric": "AnalyticKit Git SHA", "value": GIT_SHA})
        ...
        from analytickit.clickhouse.system_status import system_status
    ...
    def capture(self, request: Request) -> Response:
        from analytickit.internal_metrics import incr, timing
    ...
    def queries(self, request: Request) -> Response:
        ...
        from analytickit.clickhouse.system_status import get_clickhouse_running_queries, get_clickhouse_slow_log
    ...
    def analyze_ch_query(self, request: Request) -> Response:
        ...
        from analytickit.clickhouse.system_status import analyze_query
