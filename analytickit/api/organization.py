...
from analytickit.api.shared import TeamBasicSerializer
from analytickit.constants import AvailableFeature
from analytickit.event_usage import report_organization_deleted
from analytickit.models import Organization, User
...
from analytickit.models.team.util import delete_bulky_postgres_data
...
from analytickit.tasks.delete_clickhouse_data import delete_clickhouse_data


class PremiumMultiorganizationPermissions(permissions.BasePermission):
    """Require user to have all necessary premium features on their plan for create access to the endpoint."""

    message = "You must upgrade your AnalyticKit plan to be able to create and manage multiple organizations."
