...
from analytickit.api.capture import capture_internal
from analytickit.api.documentation import PersonPropertiesSerializer, extend_schema
from analytickit.api.routing import PKorUUIDViewSet, StructuredViewSetMixin
from analytickit.api.utils import format_paginated_url, get_pk_or_uuid, get_target_entity
...
from analytickit.models import Cohort, Filter, Person, User
from analytickit.models.activity_logging.activity_log import Change, Detail, Merge, load_activity, log_activity
from analytickit.models.activity_logging.activity_page import activity_page_response
from analytickit.models.cohort.util import get_all_cohort_ids_by_person_uuid
...
from analytickit.models.person.util import delete_ch_distinct_ids, delete_person
from analytickit.permissions import ProjectMembershipNecessaryPermissions, TeamMemberAccessPermission
from analytickit.queries.actor_base_query import ActorBaseQuery, get_people
from analytickit.queries.funnels import ClickhouseFunnelActors, ClickhouseFunnelTrendsActors
from analytickit.queries.funnels.funnel_strict_persons import ClickhouseFunnelStrictActors
from analytickit.queries.funnels.funnel_unordered_persons import ClickhouseFunnelUnorderedActors
from analytickit.queries.paths import PathsActors
from analytickit.queries.person_query import PersonQuery
from analytickit.queries.property_values import get_person_property_values_for_key
from analytickit.queries.retention import Retention
from analytickit.queries.stickiness import Stickiness
from analytickit.queries.trends.lifecycle import Lifecycle
...
class PersonViewSet(PKorUUIDViewSet, StructuredViewSetMixin, viewsets.ModelViewSet):
    ...
    def cohorts(self, request: request.Request) -> response.Response:
        from analytickit.api.cohort import CohortSerializer
