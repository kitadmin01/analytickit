...
from analytickit.models import Plugin, PluginAttachment, PluginConfig, Team
from analytickit.models.activity_logging.activity_log import (
    ActivityPage,
    Change,
    Detail,
...
from analytickit.models.activity_logging.serializers import ActivityLogSerializer
from analytickit.models.organization import Organization
from analytickit.models.plugin import PluginSourceFile, update_validated_data_from_url
from analytickit.permissions import (
    OrganizationMemberPermissions,
    ProjectMembershipNecessaryPermissions,
    TeamMemberAccessPermission,
)
from analytickit.plugins import can_configure_plugins, can_install_plugins, parse_url
from analytickit.plugins.access import can_globally_manage_plugins
from analytickit.utils import format_query_params_absolute_url

# Keep this in sync with: frontend/scenes/plugins/utils.ts
SECRET_FIELD_VALUE = "**************** ANALYTICKIT SECRET FIELD ****************"
...
def log_config_update_activity(
        new_plugin_config: PluginConfig, old_config: Dict[str, Any], secret_fields: Set[str], old_enabled: bool,
        user: Any
):
...
class PluginViewSet(StructuredViewSetMixin, viewsets.ModelViewSet):
    ...
    def all_activity(self, request: request.Request, **kwargs):
        ...
        activity_page = load_all_activity(scope_list=["Plugin", "PluginConfig"], team_id=request.user.team.id,
                                          limit=limit, page=page)  # type: ignore
...
class PluginConfigSerializer(serializers.ModelSerializer):
    ...
    def update(self, plugin_config: PluginConfig, validated_data: Dict, *args: Any,
               **kwargs: Any) -> PluginConfig:  # type: ignore
        _fix_formdata_config_json(self.context["request"], validated_data)
