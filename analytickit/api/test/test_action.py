...
from analytickit.models import Action, ActionStep, Organization, Tag
from analytickit.test.base import APIBaseTest, ClickhouseTestMixin, _create_event


class TestActionApi(ClickhouseTestMixin, APIBaseTest):
    @patch("analytickit.api.action.report_user_action")
    ...
    def test_update_action(self, patch_capture, *args):
        ...
        with self.assertNumQueries(7):
            # Django session, AnalyticKit user, AnalyticKit team, AnalyticKit org membership, AnalyticKit org
            # AnalyticKit action, AnalyticKit action step
