...
from analytickit.models import Annotation, Dashboard, DashboardTile, Insight, Organization, User
...
class TestAnnotation(APIBaseTest):
    ...
    @patch("analytickit.api.annotation.report_user_action")
    def test_retrieving_annotation(self, mock_capture):
        # Annotation creation is not reported to AnalyticKit because it has no created_by
    ...
    def test_deleting_annotation(self):
        ...
        with patch("analytickit.mixins.report_user_action"):
