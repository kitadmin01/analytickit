...
from analytickit.models import Dashboard, DashboardTile, Filter, Insight, Team, User
...
from analytickit.test.base import APIBaseTest, QueryMatchingTest, snapshot_postgres_queries
...
class TestDashboard(APIBaseTest, QueryMatchingTest):
    ...
    def test_dashboard_endpoints(self):
        # create
        response = self.client.post(f"/api/projects/{self.team.id}/dashboards/",
