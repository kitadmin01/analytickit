...
from analytickit.models import Element, ElementGroup, Organization
...
class TestElement(ClickhouseTestMixin, APIBaseTest):
    def test_element_automatic_order(self):
        elements = [
            Element(tag_name="a", href="https://analytickit.com/about", text="click here"),
    ...
    def test_event_property_values(self):
        _create_event(
            ...
            distinct_id="test",
            event="$autocapture",
            elements=[Element(tag_name="a", href="https://analytickit.com/about", text="click here")],
        )
    ...
    def test_element_stats(self):
        elements = [
            Element(tag_name="a", href="https://analytickit.com/about", text="click here", order=0, ),
            Element(tag_name="div", href="https://analytickit.com/about", text="click here", order=1, ),
        ]
        ...
        with self.assertNumQueries(6):
            # Django session, AnalyticKit user, AnalyticKit team, AnalyticKit org membership
