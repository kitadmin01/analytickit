...
from analytickit.models import Action, ActionStep, Element, Organization, Person, User
...
class TestEvents(ClickhouseTestMixin, APIBaseTest):
    ...
    def test_filter_events(self):
        _create_person(
            properties={"email": "tim@analytickit.com"},
            team=self.team,
        ...
        expected_queries = (
            8
            # Django session, AnalyticKit user, AnalyticKit team, AnalyticKit org membership, 2x team(?), person and distinct id
        )
        ...
        self.assertEqual(
            ...
            {"distinct_ids": ["2"], "is_identified": True, "properties": {"email": "tim@analytickit.com"}},
        )
    ...
    def test_filter_events_by_event_name(self):
        _create_person(
            properties={"email": "tim@analytickit.com"}, team=self.team, distinct_ids=["2", "some-random-uid"],
        )
        _create_event(
    ...
    def test_get_event_by_id(self):
        _create_person(
            properties={"email": "someone@analytickit.com"}, team=self.team, distinct_ids=["1"], is_identified=True,
        )
    ...
    @patch("analytickit.models.event.query_event_list.query_with_columns")
