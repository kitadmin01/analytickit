...
from analytickit.test.base import APIBaseTest, _create_event, flush_persons_and_events
...
class TestExports(APIBaseTest):
    ...
    @patch("analytickit.api.exports.exporter")
    ...
    @patch("analytickit.tasks.exports.csv_exporter.requests.request")
