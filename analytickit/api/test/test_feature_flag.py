...
from analytickit.models import FeatureFlag, GroupTypeMapping, User
from analytickit.models.cohort import Cohort
from analytickit.models.personal_api_key import PersonalAPIKey
from analytickit.test.base import APIBaseTest
from analytickit.test.db_context_capturing import capture_db_queries
...
class TestFeatureFlag(APIBaseTest):
                    ...
                    "groups": [
                        {
                            ...
                            "properties": [
                                {"key": "email", "type": "person", "value": "@analytickit.com",
                                 "operator": "icontains", },
                            ],
                        }
                    ]
    ...
    @patch("analytickit.api.feature_flag.report_user_action")
    ...
    def test_hard_deleting_feature_flag_is_forbidden(self):
        new_user = User.objects.create_and_join(self.organization, "new_annotations@analytickit.com", None)
    ...
    def test_get_feature_flag_activity(self):
        new_user = User.objects.create_and_join(
            ...
            email="person_acting_and_then_viewing_activity@analytickit.com",
            password=None,
            first_name="Potato",
        )
        self.client.force_login(new_user)
    ...
    def test_get_feature_flag_activity_only_from_own_team(self):
        ...
        _, org_one_team, org_one_user = User.objects.bootstrap(
            organization_name="Org 1", email="org1@analytickit.com", password=None
        )

        _, org_two_team, org_two_user = User.objects.bootstrap(
            organization_name="Org 2", email="org2@analytickit.com", password=None
        )
    ...
    def test_get_flags_with_specified_token(self):
        _, _, user = User.objects.bootstrap("Test", "team2@analytickit.com", None)
    ...
    def test_my_flags(self, mock_capture):
        ...
        distinct_id_user = User.objects.create_and_join(self.organization, "distinct_id_user@analytickit.com", None)
        ...
        distinct_id_0_user = User.objects.create_and_join(self.organization, "distinct_id_0_user@analytickit.com", None)
    ...
    def test_validation_person_properties(self):
        person_request = self._create_flag_with_properties(
            "person-flag",
            [{"key": "email", "type": "person", "value": "@analytickit.com", "operator": "icontains", }, ]
        )
    ...
    @patch("analytickit.tasks.calculate_cohort.calculate_cohort_ch.delay")
    ...
    def _get_feature_flag_activity(
            self, flag_id: Optional[int] = None, team_id: Optional[int] = None,
