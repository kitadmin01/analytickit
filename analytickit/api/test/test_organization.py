...
from analytickit.models import Organization, OrganizationMembership, Team
        ...
        with self.settings(MULTI_TENANCY=False):
            ...
            self.assertEqual(
                response.json(),
                {
                    ...
                    "detail": "You must upgrade your AnalyticKit plan to be able to create and manage multiple organizations.",
