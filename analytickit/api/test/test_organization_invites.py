...
from analytickit.models.organization import Organization, OrganizationInvite, OrganizationMembership
...
class TestOrganizationInvitesAPI(APIBaseTest):
    def helper_generate_bulk_invite_payload(self, count: int):
        ...
        for i in range(0, count):
            payload.append(
                {
                    "target_email": f"test+{random.randint(1000000, 9999999)}@analytickit.com",
    ...
    def test_cant_list_invites_for_an_alien_organization(self):
        ...
        invite = OrganizationInvite.objects.create(target_email="siloed@analytickit.com", organization=org)
