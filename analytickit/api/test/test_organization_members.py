...
class TestOrganizationMembersAPI(APIBaseTest):
    def test_list_organization_members(self):
        User.objects.create_and_join(self.organization, "1@analytickit.com", None)
        User.objects.create_and_join(self.organization, "2@analytickit.com", None, is_active=False)
    ...
    def test_cant_list_members_for_an_alien_organization(self):
        ...
        user = User.objects.create(email="another_user@analytickit.com")
