...
from analytickit.models import Cohort, Organization, Person, Team
from analytickit.models.person import PersonDistinctId
from analytickit.models.person.util import create_person
...
class TestPerson(ClickhouseTestMixin, APIBaseTest):
    ...
    @freeze_time("2021-08-25T22:09:14.252Z")
    @mock.patch("analytickit.api.capture.capture_internal")
    ...
    @mock.patch("analytickit.api.person.capture_internal")
