...
from analytickit.models.organization import Organization, OrganizationInvite
...
class TestPreflight(APIBaseTest):
    ...
    @patch("analytickit.storage.object_storage._client")
    ...
    def test_ee_preflight_with_users_limit(self):
        try:
            ...
            OrganizationInvite.objects.create(organization=self.organization, target_email="invite@analytickit.com")
