...
from analytickit.settings import ASYNC_MIGRATIONS_DEFAULT_TIMEOUT_SECONDS
...
class AsyncMigrationOperationSQL(AsyncMigrationOperation):
    ...
    def _execute_op(self, query_id: str, sql: str, settings: Optional[Dict]):
        from analytickit.async_migrations.utils import execute_op_clickhouse, execute_op_postgres
...
class AsyncMigrationDefinition:
    ...
    analytickit_min_version = "0.0.0"

    # the migration _must_ be run before this version
    analytickit_max_version = "10000.0.0"
