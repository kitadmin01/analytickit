...
from analytickit.async_migrations.utils import execute_op_clickhouse, run_optimize_table, sleep_until_finished
...
class Migration(AsyncMigrationDefinition):
    ...
    def operations(self):
        return [
            AsyncMigrationOperation(
                # See https://github.com/analytickit/analytickit/issues/10616 for details on choice of codec
