...
from analytickit.async_migrations.utils import (
    complete_migration,
    execute_op,
...
from analytickit.models.async_migration import AsyncMigration, MigrationStatus, get_all_running_async_migrations
...
def start_async_migration(
    ...
    2. The migration can be run with the current analytickit version
    ...
    """
    send_analytics_to_analytickit("Async migration start", {"name": migration_name})
    ...
    analytickit_version_valid = ignore_analytickit_version or is_analytickit_version_compatible(
...
def run_next_migration(candidate: str):
    ...
    migration_in_range = is_analytickit_version_compatible(
        migration_instance.analytickit_min_version, migration_instance.analytickit_max_version
    )
