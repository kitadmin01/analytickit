...
from analytickit.async_migrations.setup import get_async_migration_definition, setup_async_migrations
...
from analytickit.models.person.util import create_person, create_person_distinct_id, delete_person
from analytickit.models.utils import UUIDT
from analytickit.test.base import ClickhouseTestMixin, run_clickhouse_statement_in_parallel
...
def run_migration():
    ...
    return start_async_migration(MIGRATION_NAME, ignore_analytickit_version=True)
