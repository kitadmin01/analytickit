...
def create_clickhouse_tables(num_tables: int):
    ...
    from analytickit.clickhouse.schema import CREATE_DISTRIBUTED_TABLE_QUERIES, CREATE_MERGETREE_TABLE_QUERIES, \
        build_query
...
def reset_clickhouse_tables():
    ...
    # Mostly so that test runs locally work correctly
    from analytickit.clickhouse.dead_letter_queue import TRUNCATE_DEAD_LETTER_QUEUE_TABLE_SQL
    from analytickit.clickhouse.plugin_log_entries import TRUNCATE_PLUGIN_LOG_ENTRIES_TABLE_SQL
    from analytickit.models.cohort.sql import TRUNCATE_COHORTPEOPLE_TABLE_SQL
    from analytickit.models.event.sql import TRUNCATE_EVENTS_TABLE_SQL
    from analytickit.models.group.sql import TRUNCATE_GROUPS_TABLE_SQL
    ...
    from analytickit.models.session_recording_event.sql import TRUNCATE_SESSION_RECORDING_EVENTS_TABLE_SQL
