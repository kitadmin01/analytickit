...
from analytickit.constants import INSIGHT_TRENDS, TRENDS_LINEAR, TRENDS_WORLD_MAP
from analytickit.demo.matrix.matrix import Cluster, Matrix
from analytickit.demo.matrix.models import SimPerson, SimSessionIntent
from analytickit.models import Cohort, Dashboard, DashboardTile, Experiment, FeatureFlag, Insight, InsightViewed

# This is a simulation of an online drive SaaS called Hedgebox
# See this RFC for the reasoning behind it:
# https://github.com/analytickit/product-internal/blob/main/requests-for-comments/2022-03-23-great-demo-data.md
