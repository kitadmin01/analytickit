...
from analytickit.infi.clickhouse_orm.database import ServerError, DatabaseException
from analytickit.infi.clickhouse_orm.models import Model
from analytickit.infi.clickhouse_orm.engines import Memory
from analytickit.infi.clickhouse_orm.fields import *
from analytickit.infi.clickhouse_orm.funcs import F
from analytickit.infi.clickhouse_orm.query import Q
...
class DatabaseTestCase(TestCaseWithData):
    ...
    def test_create_ad_hoc_field(self):
        ...
        from analytickit.infi.clickhouse_orm.models import ModelBase
