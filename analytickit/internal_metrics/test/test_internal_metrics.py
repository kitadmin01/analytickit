...
from analytickit.internal_metrics import gauge, incr, timing
from analytickit.internal_metrics.team import (
...
def mock_capture_internal(mocker: MockerFixture):
    ...
    mocker.patch("analytickit.utils.get_machine_id", return_value="machine_id")
    yield mocker.patch("analytickit.api.capture.capture_internal")
