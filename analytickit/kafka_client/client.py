...
from analytickit.client import async_execute, sync_execute
from analytickit.kafka_client import helper
...
from analytickit.utils import SingletonDecorator
...
class _KafkaProducer:
    ...
    def on_send_success(self, record_metadata: RecordMetadata):
        statsd.incr(
            "analytickit_cloud_kafka_send_success", tags={"topic": record_metadata.topic, },
        )

    def on_send_failure(self, topic: str, exc: Exception):
        statsd.incr("analytickit_cloud_kafka_send_failure", tags={"topic": topic, "exception": exc.__class__.__name__})
