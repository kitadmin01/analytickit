...
from analytickit.kafka_client.client import _KafkaProducer, build_kafka_consumer
...
class KafkaClientTestCase(TestCase):
    ...
    @patch("analytickit.kafka_client.client.KAFKA_SECURITY_PROTOCOL", "SASL_PLAINTEXT")
    @patch("analytickit.kafka_client.client.KAFKA_SASL_MECHANISM", "<mechanism>")
    @patch("analytickit.kafka_client.client.KAFKA_SASL_USER", "<user>")
    @patch("analytickit.kafka_client.client.KAFKA_SASL_PASSWORD", "<password>")
    ...
    @patch("analytickit.kafka_client.client.KAFKA_SECURITY_PROTOCOL", "SSL")
    @patch("analytickit.kafka_client.client.KAFKA_SASL_MECHANISM", "<mechanism>")
    @patch("analytickit.kafka_client.client.KAFKA_SASL_USER", "<user>")
    @patch("analytickit.kafka_client.client.KAFKA_SASL_PASSWORD", "<password>")
