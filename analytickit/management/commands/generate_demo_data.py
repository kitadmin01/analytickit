...
from analytickit.demo.matrix.manager import MatrixManager
from analytickit.demo.matrix.models import SimEvent
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--email", type=str, default="test@analytickit.com",
            help="Email of the demo user (default: test@analytickit.com)",
        )
        parser.add_argument(
