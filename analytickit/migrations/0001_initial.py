# Generated by Django 3.2.14 on 2022-11-26 13:36
...
import analytickit.models.activity_logging.activity_log
import analytickit.models.exported_asset
import analytickit.models.insight
import analytickit.models.organization_domain
import analytickit.models.sharing_configuration
import analytickit.models.team.team
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("uuid", models.UUIDField(default=analytickit.models.utils.UUIDT, editable=False, unique=True)),
                ...
                (
                    ...
                    models.JSONField(default=analytickit.models.user.events_column_config_default),
                ),
            ],
            options={"verbose_name": "user", "verbose_name_plural": "users", "abstract": False,},
            managers=[("objects", analytickit.models.user.UserManager()),],
        ),
        migrations.CreateModel(
            name="Action",
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "detail",
                    models.JSONField(
                        encoder=analytickit.models.activity_logging.activity_log.ActivityDetailEncoder, null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("analytickit_min_version", models.CharField(blank=True, max_length=20, null=True)),
                ("analytickit_max_version", models.CharField(blank=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default=analytickit.models.exported_asset.get_default_access_token,
                        max_length=400,
                        null=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "short_id",
                    models.CharField(blank=True, default=analytickit.models.insight.generate_short_id, max_length=12),
                ),
            ...
            options={"db_table": "analytickit_dashboarditem",},
        ),
        migrations.CreateModel(
            name="InsightViewed",
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("slug", analytickit.models.utils.LowercaseSlugField(max_length=48, unique=True)),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("uuid", models.UUIDField(db_index=True, default=analytickit.models.utils.UUIDT, editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "api_token",
                    models.CharField(
                        default=analytickit.models.utils.generate_random_token_project,
                        max_length=200,
                        unique=True,
                        validators=[
                ...
                ("data_attributes", models.JSONField(default=analytickit.models.team.team.get_default_data_attributes)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "dashboard",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.CASCADE, to="analytickit.dashboard"
                    ),
                ),
                (
                    "insight",
                    models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to="analytickit.insight"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default=analytickit.models.sharing_configuration.get_default_access_token,
                        max_length=400,
                        null=True,
                        unique=True,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("completed", models.BooleanField(default=False)),
                ("dismissed", models.BooleanField(default=False)),
                ("person", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="analytickit.person")),
                ("team", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="analytickit.team")),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name="team",
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to="analytickit.team"),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "plugin_config",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.CASCADE, to="analytickit.pluginconfig"
                    ),
                ),
                (
                    "team",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "team",
                    models.ForeignKey(
                        db_index=False, on_delete=django.db.models.deletion.CASCADE, to="analytickit.team"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value",
                    models.CharField(
                        default=analytickit.models.utils.generate_random_token_personal,
                        editable=False,
                        max_length=50,
                        unique=True,
                    ),
        ...
        migrations.AddField(
            ...
            name="insight",
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="analytickit.insight"),
        ),
        migrations.AddField(
            model_name="insightviewed",
            name="team",
        ...
        migrations.AddField(
            ...
            name="dive_dashboard",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="analytickit.dashboard"
            ),
        ),
        migrations.AddField(
            model_name="insight",
        ...
        migrations.AddField(
            ...
            name="feature_flag",
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="analytickit.featureflag"),
        ),
        migrations.AddField(
            model_name="featureflagoverride",
            name="team",
        ...
        migrations.AddField(
            ...
            name="person",
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="analytickit.person"),
        ),
        migrations.AddField(
            model_name="featureflaghashkeyoverride",
            name="team",
        ...
        migrations.AddField(
            model_name="exportedasset",
            name="dashboard",
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to="analytickit.dashboard"),
        ),
        migrations.AddField(
            model_name="exportedasset",
            name="insight",
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to="analytickit.insight"),
        ),
        migrations.AddField(
            model_name="exportedasset",
            name="team",
        ...
        migrations.AddField(
            ...
            name="event",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="analytickit.event"
            ),
        ),
        migrations.AddField(
            model_name="element",
            name="group",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="analytickit.elementgroup"
            ),
        ),
        migrations.AddField(
            model_name="dashboardtile",
            name="dashboard",
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="analytickit.dashboard"),
        ),
        migrations.AddField(
            model_name="dashboardtile",
            name="insight",
        ...
        migrations.AddField(
            ...
            name="insights",
            field=models.ManyToManyField(
                blank=True, related_name="dashboards", through="analytickit.DashboardTile", to="analytickit.Insight"
            ),
        ),
        migrations.AddField(
            model_name="dashboard",
        ...
        migrations.AddField(
            ...
            name="cohort",
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="analytickit.cohort"),
        ),
        migrations.AddField(
            model_name="cohortpeople",
            name="person",
        ...
        migrations.AddField(
            model_name="cohort",
            name="people",
            field=models.ManyToManyField(through="analytickit.CohortPeople", to="analytickit.Person"),
        ),
        migrations.AddField(
            model_name="cohort",
            name="team",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="analytickit.asyncmigration"),
        ),
        migrations.AddConstraint(
            model_name="asyncmigration", constraint=models.UniqueConstraint(fields=("name",), name="unique name"),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="dashboard_item",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="analytickit.insight"
            ),
        ),
        migrations.AddField(
            model_name="annotation",
            name="organization",
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.CASCADE, to="analytickit.organization"
            ),
        ),
        migrations.AddField(
            model_name="annotation",
        ...
        migrations.AddField(
            ...
            name="action",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="steps", to="analytickit.action"
            ),
        ),
        migrations.AddField(
            model_name="action",
        ...
        migrations.AddIndex(
            model_name="sessionrecordingevent",
            index=models.Index(
                fields=["team_id", "distinct_id", "timestamp", "session_id"], name="analytickit_team_id_d9f6fd_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="propertydefinition",
        ...
        migrations.AlterUniqueTogether(name="propertydefinition", unique_together={("team", "name")},),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            model_name="insightviewed",
            constraint=models.UniqueConstraint(
                fields=("team", "user", "insight"), name="analytickit_unique_insightviewed"
            ),
        ),
        migrations.AlterUniqueTogether(name="insight", unique_together={("team", "short_id")},),
        migrations.AddConstraint(
            model_name="grouptypemapping",
        ...
        migrations.AlterUniqueTogether(name="eventdefinition", unique_together={("team", "name")},),
        migrations.AddIndex(
            model_name="event", index=models.Index(fields=["elements_hash"], name="analytickit_element_4bfb87_idx"),
        ),
        migrations.AddIndex(
            model_name="event",
