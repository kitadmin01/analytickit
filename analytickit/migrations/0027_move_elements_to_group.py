...
def forwards(apps, schema_editor):
    Event = apps.get_model("analytickit", "Event")
    ElementGroup = apps.get_model("analytickit", "ElementGroup")
    Element = apps.get_model("analytickit", "Element")
...
class Migration(migrations.Migration):
    atomic = False
    dependencies = [
        ("analytickit", "0026_auto_20200227_0804"),
    ]
