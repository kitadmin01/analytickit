...
class Migration(migrations.Migration):
    dependencies = [
        ("analytickit", "0049_delete_funnelstep"),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.CASCADE, related_name="items",
        ...
        migrations.AlterField(
            ...
            name="dashboard",
            field=models.ForeignKey(
                null=False, on_delete=django.db.models.deletion.CASCADE, related_name="items",
                to="analytickit.Dashboard",
            ),
        ),
    ]
