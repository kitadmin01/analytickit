...
def forwards_func(apps, schema_editor):
    ...
    OrganizationMembership = apps.get_model("analytickit", "OrganizationMembership")
    Annotation = apps.get_model("analytickit", "Annotation")
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name="team",
            name="api_token",
            field=models.CharField(default=analytickit.models.utils.generate_random_token, max_length=200, null=True, ),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name="team",
            name="uuid",
            field=models.UUIDField(default=analytickit.models.utils.UUIDT, editable=False, unique=True),
        ),
        migrations.AlterField(
            model_name="user",
            name="distinct_id",
