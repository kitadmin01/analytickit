...
class Migration(migrations.Migration):
    dependencies = [
        ("analytickit", "0089_auto_20201015_1031"),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                default=analytickit.models.utils.generate_random_token, max_length=200, null=True, unique=True
            ),
        ),
        migrations.AlterField(
            model_name="team",
        ...
        migrations.AlterField(
            model_name="person",
            name="uuid",
            field=models.UUIDField(db_index=True, default=analytickit.models.utils.UUIDT, editable=False),
        ),
        migrations.AlterField(
            model_name="team",
            name="name",
