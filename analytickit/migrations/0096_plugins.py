...
class Migration(migrations.Migration):
    dependencies = [
        ("analytickit", "0095_session_recording_event_table"),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("error", django.contrib.postgres.fields.jsonb.JSONField(default=None, null=True),),
                ("plugin", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="analytickit.Plugin"),),
                (
                    "team",
                    models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to="analytickit.Team", ),
                ),
            ],
        ),
