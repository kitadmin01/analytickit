...
def create_short_ids(apps, schema_editor):
    DashboardItem = apps.get_model("analytickit", "DashboardItem")
    for obj in DashboardItem.objects.all():
        obj.short_id = analytickit.models.insight.generate_short_id()
        obj.save()


class Migration(migrations.Migration):
    # This avoids: "cannot ALTER TABLE "analytickit_dashboarditem" because it has pending trigger events"
    # Basically, we can't alter a table and change its data inside one transaction
    atomic = False

    dependencies = [
        ("analytickit", "0155_organization_available_features"),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name="short_id",
            field=models.CharField(blank=True, max_length=12, default=analytickit.models.insight.generate_short_id),
        ),
