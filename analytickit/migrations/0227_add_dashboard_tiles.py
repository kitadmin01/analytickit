...
def migrate_dashboard_insight_relations(apps, _) -> None:
    ...
    with connection.cursor() as cursor:
        ...
        and don't already have a analytickit_dashboardtile relation
        """
        cursor.execute(
            """
            SELECT old_relation.id, old_relation.dashboard_id, old_relation.layouts, old_relation.color
            FROM analytickit_dashboarditem as old_relation
            LEFT JOIN analytickit_dashboardtile new_relation
...
class Migration(migrations.Migration):
    dependencies = [
        ("analytickit", "0226_longer_action_slack_message_format"),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("dashboard", models.ForeignKey(on_delete=models.deletion.CASCADE, to="analytickit.dashboard")),
                ("insight", models.ForeignKey(on_delete=models.deletion.CASCADE, to="analytickit.insight")),
