...
def migrate_plugin_source(apps, schema_editor):
    Plugin = apps.get_model("analytickit", "Plugin")
    PluginSourceFile = apps.get_model("analytickit", "PluginSourceFile")
...
class Migration(migrations.Migration):
    dependencies = [
        ("analytickit", "0232_add_team_person_display_name_properties"),
    ]
