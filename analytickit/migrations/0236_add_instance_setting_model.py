...
def populate_instance_settings(apps, schema_editor):
    try:
        InstanceSetting = apps.get_model("analytickit", "InstanceSetting")
        ...
        logger.info("constance_config table did not exist, skipping populating analytickit_instance_setting table")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("analytickit", "0235_plugin_source_transpilation"),
    ]
