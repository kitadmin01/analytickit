...
def log_deletion_metadata_to_analytickit(func):
    """
    wraps a DRF destroy endpoint and sends a AnalyticKit event recording its deletion
    so:
...
class AnalyticsDestroyModelMixin:
    ...
    @log_deletion_metadata_to_analytickit
