...
from analytickit.constants import AUTOCAPTURE_EVENT, TREND_FILTER_TYPE_ACTIONS
from analytickit.models import Entity, Filter
from analytickit.models.action import Action
from analytickit.models.action_step import ActionStep
from analytickit.models.property import Property, PropertyIdentifier
...
def format_action_filter(
    ...
    for index, step in enumerate(steps):
        ...
        if step.event == AUTOCAPTURE_EVENT:
            from analytickit.models.property.util import filter_element  # prevent circular import
...
def get_action_tables_and_properties(action: Action) -> Counter[PropertyIdentifier]:
    from analytickit.models.property.util import extract_tables_and_properties
