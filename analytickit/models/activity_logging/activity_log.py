...
from analytickit.models.utils import UUIDT, UUIDModel
...
class ActivityLog(UUIDModel):
    ...
    user = models.ForeignKey("analytickit.User", null=True, on_delete=models.SET_NULL)
...
def load_activity(
    ...
    # TODO in follow-up to analytickit #8931 selecting specific fields into a return type from this query
