...
class Annotation(models.Model):
    ...
    dashboard_item: models.ForeignKey = models.ForeignKey(
        "analytickit.Insight", on_delete=models.SET_NULL, null=True, blank=True
    )
    team: models.ForeignKey = models.ForeignKey("analytickit.Team", on_delete=models.CASCADE)
    organization: models.ForeignKey = models.ForeignKey("analytickit.Organization", on_delete=models.CASCADE, null=True)
