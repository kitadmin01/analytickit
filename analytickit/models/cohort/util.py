...
from analytickit.models import Action, Filter, Team
from analytickit.models.action.util import format_action_filter
from analytickit.models.cohort.cohort import Cohort
from analytickit.models.cohort.sql import (
...
from analytickit.models.person.sql import GET_PERSON_IDS_BY_FILTER, INSERT_PERSON_STATIC_COHORT, \
...
def get_properties_cohort_subquery(cohort: Cohort, cohort_group: Dict, group_idx: int) -> Tuple[str, Dict[str, Any]]:
    from analytickit.models.property.util import prop_filter_json_extract
