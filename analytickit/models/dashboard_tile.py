...
from analytickit.models.insight import Insight, generate_insight_cache_key


class DashboardTile(models.Model):
    # Relations
    dashboard = models.ForeignKey("analytickit.Dashboard", on_delete=models.CASCADE)
    insight = models.ForeignKey("analytickit.Insight", on_delete=models.CASCADE)
