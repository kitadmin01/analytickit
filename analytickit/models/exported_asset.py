...
class ExportedAsset(models.Model):
    ...
    dashboard = models.ForeignKey("analytickit.Dashboard", on_delete=models.CASCADE, null=True)
    insight = models.ForeignKey("analytickit.Insight", on_delete=models.CASCADE, null=True)
