...
from analytickit.models.property import GroupTypeIndex, GroupTypeName
from analytickit.models.property.property import Property
from analytickit.models.signals import mutable_receiver
from analytickit.queries.base import match_property, properties_to_Q
...
class FeatureFlag(models.Model):
    ...
    def update_cohorts(self) -> None:
        from analytickit.tasks.calculate_cohort import update_cohort
        from analytickit.tasks.cohorts_in_feature_flag import COHORT_ID_IN_FF_KEY
...
def get_active_feature_flags(
    ...
    if hash_key_override is not None:
        ...
        if person_id is None:
            ...
            # then https://github.com/analytickit/analytickit/blob/master/plugin-server/src/worker/ingestion/person-state.ts#L421
