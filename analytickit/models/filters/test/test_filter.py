...
from analytickit.models import Cohort, Filter, Person, Team
from analytickit.models.property import Property
from analytickit.queries.base import properties_to_Q
from analytickit.test.base import BaseTest, _create_person, flush_persons_and_events
...
def property_to_Q_test_factory(filter_persons: Callable, person_factory):
    class TestPropertiesToQ(BaseTest):
        ...
        def test_filter_out_team_members_persons(self):
            person_factory(team_id=self.team.pk, distinct_ids=["team_member"],
