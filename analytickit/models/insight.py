...
from analytickit.utils import absolute_uri, generate_cache_key
...
class Insight(models.Model):
    ...
    class Meta:
        db_table = "analytickit_dashboarditem"
        unique_together = (
            "team",
            "short_id",
        )
...
class InsightViewed(models.Model):
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=["team", "user", "insight"], name="analytickit_unique_insightviewed"),
        ]
        indexes = [
