...
from analytickit.constants import MAX_SLUG_LENGTH, AvailableFeature
from analytickit.email import is_email_available
from analytickit.models.utils import LowercaseSlugField, UUIDModel, create_with_slug, sane_repr
from analytickit.utils import absolute_uri, mask_email_address
...
class Organization(UUIDModel):
    ...
    members: models.ManyToManyField = models.ManyToManyField(
        "analytickit.User",
        through="analytickit.OrganizationMembership",
...
class OrganizationInvite(UUIDModel):
    organization: models.ForeignKey = models.ForeignKey(
        "analytickit.Organization", on_delete=models.CASCADE, related_name="invites", related_query_name="invite",
    )
    ...
    def use(self, user: "User", *, prevalidated: bool = False) -> None:
        ...
        if is_email_available(with_absolute_urls=True) and self.organization.is_member_join_email_enabled:
            from analytickit.tasks.email import send_member_join
