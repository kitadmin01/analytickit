...
class PersonalAPIKey(models.Model):
    ...
    user = models.ForeignKey("analytickit.User", on_delete=models.CASCADE, related_name="personal_api_keys")
    ...
    team = models.ForeignKey(
        "analytickit.Team", on_delete=models.SET_NULL, related_name="personal_api_keys+", null=True, blank=True
    )
