        ...
        "prompts": [
            {
                ...
                "text": "Welcome to analytickit! We’d like to give you a quick overview of how things work. You can skip this introduction at any time, or restart it from the help menu.",
                ...
                "icon": "messages",
                # tbd if makes sense to add to the config, displays a different icon in the tooltips
            },
        ],
        "rule": {
            "path": "/*"
    ...
    },
    {
        ...
        "prompts": [
            ...
            },
            {
                "step": 1,
                "type": "tooltip",
                "text": "Tags are used across analytickit to help you stay organized. As you create more dashboards, titles and tags becomes even more useful.",
                "placement": "top-start",
        ...
        "prompts": [
            {
                ...
                "buttons": [{"url": "https://analytickit.com/docs/user-guides/insights", "label": "Open User Guides"}],
                "placement": "top-start",
            ...
            },
            {
                ...
                "buttons": [
                    {"url": "https://analytickit.com/tutorials/filter-internal-users",
                     "label": "Insight Filters tutorial"}
                ],
                "placement": "top-start",
                "reference": "insight-view",
                "icon": "insight",
        ...
        "prompts": [
            {
                "step": 0,
                "type": "tooltip",
                "text": "This is a list of session recordings from your users. analytickit is careful about what it records, but you can also set your own privacy rules to protect users.",
                "buttons": [
                    {
                        "url": "https://analytickit.com/docs/user-guides/recordings#ignoring-sensitive-elements",
        ...
        "prompts": [
            {
                ...
                "buttons": [
                    {"url": "https://analytickit.com/docs/user-guides/experimentation",
                     "label": "Open Experiments docs"}
                ],
                "placement": "top-start",
    ...
    },
    {
        ...
        "prompts": [
            ...
            },
            {
                ...
                "buttons": [
                    {
                        "url": "https://analytickit.com/docs/user-guides/experimentation#advanced-whats-under-the-hood",
        ...
        "prompts": [
            {
                "step": 0,
                "type": "tooltip",
                "text": "analytickit doesn’t capture performance info on all events, but when it does you can see it here. You can also use Filters to find specific events, if needed.",
                "placement": "top-start",
    ...
    },
    {
        ...
        "prompts": [
            ...
            },
            {
                ...
                "buttons": [{"url": "https://analytickit.com/docs/integrate", "label": "Open the docs"}],
                "placement": "top-start",
        ...
        "prompts": [
            {
                "step": 0,
                "type": "tooltip",
                "text": "Here you can see every event analytickit has ingested, as well as how often it’s been used for insights in the last 30 days. Click any event to get more information.",
                "placement": "top-start",
        ...
        "prompts": [
            {
                "step": 0,
                "type": "tooltip",
                "text": "Here you can see every user analytickit has tracked. Unidentified users are assigned an ID key, while identified users are listed by their email address.",
                "placement": "top-start",
        ...
        "prompts": [
            {
                "step": 0,
                "type": "tooltip",
                "text": "This page collects all information analytickit has on this individual, including session records and any cohorts they belong to.",
                "placement": "top-start",
            ...
            },
            {
                "step": 1,
                "type": "tooltip",
                "text": "Sometimes you may capture a user’s info twice, or you may need to delete records of an individual. In either situation, analytickit can do that.",
                "placement": "top-start",
    ...
    },
    {
        ...
        "prompts": [
            ...
            },
            {
                "step": 1,
                "type": "tooltip",
                "text": "Annotations can be really helpful later down the road, especially for new team members. Getting into the habit of adding annotations will help you get the most out of analytickit.",
                "placement": "top-start",
        ...
        "prompts": [
            {
                "step": 0,
                "type": "tooltip",
                "text": "analytickit has a growing library of apps to help you import, export or transform data. Once you’ve installed an app, click the blue gear icon to configure it.",
                "placement": "top-start",
                "reference": "apps-tabs",
                "icon": "apps",
            },
            {
                "step": 1,
                "type": "tooltip",
                "text": "Apps in analytickit function as a chain, with one acting after another before data is stored. Here, you can drag enabled apps to run in any order you’d like.",
                "placement": "top-start",
                "reference": "apps-tabs",
                "icon": "apps",
            },
            {
                "step": 2,
                "type": "tooltip",
                "text": "Can’t find the app you need? Everything on analytickit is open source, so use the Advanced tab to get started building and releasing your own apps to the community!",
                "placement": "top-start",
                "reference": "apps-tabs",
                "icon": "apps",
            },
        ...
        "prompts": [
            {
                "step": 0,
                "type": "tooltip",
                "text": "If you’re signed in to analytickit, the toolbar enables you to make some changes right within your product. Just authorize a domain, enable the toolbar and away you go!",
                "placement": "top-start",
