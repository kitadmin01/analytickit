...
from analytickit.models.utils import UUIDClassicModel, generate_random_token_project, sane_repr
from analytickit.settings.utils import get_list
from analytickit.utils import GenericEmails
...
class Team(UUIDClassicModel):
    organization: models.ForeignKey = models.ForeignKey(
        "analytickit.Organization", on_delete=models.CASCADE, related_name="teams", related_query_name="team"
    )
    ...
    name: models.CharField = models.CharField(
        max_length=200, default="Default Campaign", validators=[MinLengthValidator(1, "Campaign must have a name!")],
    )
    ...
    primary_dashboard: models.ForeignKey = models.ForeignKey(
        "analytickit.Dashboard", on_delete=models.SET_NULL, null=True, related_name="primary_dashboard_teams"
    )  # Dashboard shown on project homepage

    # This is meant to be used as a stopgap until https://github.com/analytickit/meta/pull/39 gets implemented
    ...
    def actor_on_events_querying_enabled(self) -> bool:
        ...
        return analytickitanalytics.feature_enabled(
