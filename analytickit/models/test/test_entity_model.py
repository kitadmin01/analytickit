...
from analytickit.models.entity import TREND_FILTER_TYPE_ACTIONS, TREND_FILTER_TYPE_EVENTS, Entity
        ...
        entity1 = Entity(
            {
                ...
                "properties": [
                    ...
                    {"key": "current_url", "value": "test@analytickit.com", "type": "element"},
                ],
            }
        )
        entity2 = Entity(
            {
                "id": "e1",
                "type": TREND_FILTER_TYPE_EVENTS,
                "properties": [{"key": "current_url", "value": "test@analytickit.com", "type": "element"}, ],
            }
        )
        ...
        entity2 = Entity(
            {
                ...
                "type": TREND_FILTER_TYPE_EVENTS,
                "properties": [
                    {"key": "current$url", "value": "test@analytickit.com", "type": "element"},
                    {"key": "email", "value": "test@analytickit.com", "type": "person"},
                ],
            }
        )
