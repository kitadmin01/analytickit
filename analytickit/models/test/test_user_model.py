...
class TestUser(BaseTest):
    ...
    def test_analytics_metadata(self):
        ...
        organization, team, user = User.objects.bootstrap(
            organization_name="Test Org", email="test_org@analytickit.com", password="12345678", anonymize_data=True,
        )
        ...
        user_2: User = User.objects.create(email="test_org_2@analytickit.com", email_opt_in=True)
        ...
        with self.settings(MULTI_TENANCY=False):
            self.assertEqual(
                user_2.get_analytics_metadata(),
                {
                    ...
                    "email": "test_org_2@analytickit.com",
                    "is_signed_up": True,
                    "organization_count": 1,
                    "project_count": 2,
