...
class User(AbstractUser, UUIDClassicModel):
    ...
    current_organization = models.ForeignKey(
        "analytickit.Organization", models.SET_NULL, null=True, related_name="users_currently+",
    )
    current_team = models.ForeignKey("analytickit.Team", models.SET_NULL, null=True, related_name="teams_currently+")
