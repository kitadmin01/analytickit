...
from analytickit.plugins.utils import (
...
class TestPluginsUtils(BaseTest):
    def test_parse_github_urls(self, mock_get):
        parsed_url = parse_url("https://github.com/analytickit/analytickit")
        ...
        parsed_url = parse_url("https://github.com/analytickit/analytickit", get_latest_if_none=True)
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "analytickit")
        self.assertEqual(parsed_url["repo"], "analytickit")
        ...
        parsed_url = parse_url(
            "https://github.com/analytickit/analytickit/releases/tag/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e"
        )
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "analytickit")
        self.assertEqual(parsed_url["repo"], "analytickit")
        ...
        parsed_url = parse_url(
            "https://www.github.com/analytickit/analytickit/archive/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e.zip"
        )
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "analytickit")
        self.assertEqual(parsed_url["repo"], "analytickit")
        ...
        parsed_url = parse_url(
            "https://github.com/analytickit/analytickit/archive/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e.tar.gz"
        )
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "analytickit")
        self.assertEqual(parsed_url["repo"], "analytickit")
        ...
        mock_get.assert_called_with(
            "https://api.github.com/repos/analytickit/analytickit/commits", headers={"Authorization": "token TOKEN"}
        )
        self.assertEqual(mock_get.call_count, 2)

        parsed_url = parse_url(
            "https://github.com/analytickit/analytickit/tree/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e?private_token=TOKEN"
        )
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "analytickit")
        self.assertEqual(parsed_url["repo"], "analytickit")
        ...
        with self.settings(GITHUB_TOKEN="MY_GITHUB_TOKEN"):
            ...
            mock_get.assert_called_with(
                "https://api.github.com/repos/analytickit/analytickit/commits",
    ...
    def test_parse_npm_urls(self, mock_get):
        ...
        parsed_url = parse_url("https://www.npmjs.com/package/@analytickit/helloworldplugin")
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "@analytickit/helloworldplugin")
        self.assertEqual(parsed_url.get("tag", None), None)
        self.assertEqual(mock_get.call_count, 0)

        parsed_url = parse_url("https://www.npmjs.com/package/analytickit-helloworld-plugin", get_latest_if_none=True)
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "analytickit-helloworld-plugin")
        self.assertEqual(parsed_url["tag"], "MOCK")
        self.assertEqual(mock_get.call_count, 1)
        mock_get.assert_called_with("https://registry.npmjs.org/analytickit-helloworld-plugin/latest", headers={})

        parsed_url = parse_url("https://www.npmjs.com/package/@analytickit/helloworldplugin", get_latest_if_none=True)
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "@analytickit/helloworldplugin")
        self.assertEqual(parsed_url["tag"], "MOCK")
        self.assertEqual(mock_get.call_count, 2)
        mock_get.assert_called_with("https://registry.npmjs.org/@analytickit/helloworldplugin/latest", headers={})

        parsed_url = parse_url("https://www.npmjs.com/package/analytickit-helloworld-plugin/v/0.0.0")
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "analytickit-helloworld-plugin")
        self.assertEqual(parsed_url["tag"], "0.0.0")
        self.assertEqual(mock_get.call_count, 2)

        parsed_url = parse_url("https://www.npmjs.com/package/@analytickit/helloworldplugin/v/0.0.0")
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "@analytickit/helloworldplugin")
        self.assertEqual(parsed_url["tag"], "0.0.0")
        self.assertEqual(mock_get.call_count, 2)
        ...
        parsed_url = parse_url(
            "https://www.npmjs.com/package/analytickit-helloworld-plugin/v/0.0.0", get_latest_if_none=True
        )
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "analytickit-helloworld-plugin")
        self.assertEqual(parsed_url["tag"], "0.0.0")
        ...
        # private tokens
        parsed_url = parse_url(
            "https://www.npmjs.com/package/analytickit-helloworld-plugin?private_token=TOKEN", get_latest_if_none=True
        )
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "analytickit-helloworld-plugin")
        self.assertEqual(parsed_url["tag"], "MOCK")
        ...
        self.assertEqual(mock_get.call_count, 3)
        mock_get.assert_called_with(
            "https://registry.npmjs.org/analytickit-helloworld-plugin/latest", headers={"Authorization": "Bearer TOKEN"}
        )
    ...
    def test_download_plugin_archive_github(self, mock_get):
        plugin_github_zip_1 = download_plugin_archive(
            "https://www.github.com/analytickit/helloworldplugin/commit/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e",
            HELLO_WORLD_PLUGIN_GITHUB_ZIP[0],
        )
        self.assertEqual(plugin_github_zip_1, base64.b64decode(HELLO_WORLD_PLUGIN_GITHUB_ZIP[1]))
        self.assertEqual(mock_get.call_count, 1)
        mock_get.assert_called_with(
            "https://github.com/analytickit/helloworldplugin/archive/d5aa1d2b8a534f37cd93be48b214f490ef9ee904.zip",
            headers={},
        )

        plugin_github_zip_2 = download_plugin_archive(
            "https://www.github.com/analytickit/helloworldplugin/commit/{}".format(HELLO_WORLD_PLUGIN_GITHUB_ZIP[0])
        )
        ...
        plugin_github_zip_3 = download_plugin_archive(
            "https://www.github.com/analytickit/helloworldplugin/commit/{}?private_token=TOKEN".format(
                HELLO_WORLD_PLUGIN_GITHUB_ZIP[0]
            )
        )
    ...
    def test_download_plugin_archive_npm(self, mock_get):
        plugin_npm_tgz = download_plugin_archive("https://www.npmjs.com/package/analytickit-helloworld-plugin/v/0.0.0")
        ...
        self.assertEqual(mock_get.call_count, 2)
        mock_get.assert_called_with(
            "https://registry.npmjs.org/@analytickit/helloworldplugin/-/helloworldplugin-0.0.0.tgz",
            headers={"Authorization": "Bearer TOKEN"},
        )
    ...
    def test_put_json_into_zip_archive(self, mock_get):
        ...
        plugin_json["analytickitVersion"] = "0.0.0"
        ...
        self.assertEqual(new_plugin_json["analytickitVersion"], "0.0.0")
        ...
        self.assertEqual(new_plugin_json_2["analytickitVersion"], "0.0.0")
