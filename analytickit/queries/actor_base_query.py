...
from analytickit.constants import INSIGHT_FUNNELS, INSIGHT_PATHS, INSIGHT_TRENDS
...
class ActorBaseQuery:
    ...
    def get_actors(
        ...
        if hasattr(self._filter, "include_recordings") and self._filter.include_recordings and self._filter.insight in [
            INSIGHT_PATHS, INSIGHT_TRENDS, INSIGHT_FUNNELS]:  # type: ignore
...
def serialize_people(data: QuerySet[Person]) -> List[SerializedPerson]:
    from analytickit.api.person import get_person_name
