...
from analytickit.clickhouse.materialized_columns import ColumnName
from analytickit.models import Cohort, Filter, Property
from analytickit.models.cohort.util import is_precalculated_query
...
from analytickit.models.property import PropertyGroup, PropertyName
...
class EventQuery(metaclass=ABCMeta):
    ...
    def _determine_should_join_persons(self) -> None:
        ...
        #   Can be simplified significantly after https://github.com/analytickit/analytickit/issues/5854
