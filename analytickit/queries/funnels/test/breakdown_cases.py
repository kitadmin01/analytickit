...
from analytickit.queries.breakdown_props import ALL_USERS_COHORT_ID
from analytickit.queries.funnels.funnel import ClickhouseFunnel
from analytickit.test.base import APIBaseTest, snapshot_clickhouse_queries, test_with_materialized_columns
...
def funnel_breakdown_test_factory(Funnel, FunnelPerson, _create_event, _create_action, _create_person):
    class TestFunnelBreakdown(APIBaseTest):
        ...
        def test_basic_funnel_default_funnel_days_breakdown_event(self):
                ...
                "user_1": [
                    {
                        ...
                        "timestamp": datetime(2020, 1, 2, 14),
                        "properties": {"$current_url": "https://analytickit.com/docs/x"},
                    },
                    {
                        "event": "paid",
            ...
            # See https://github.com/analytickit/analytickit/pull/5496
                    ...
                    events_by_person["user_1"].append(
                        {
                            "event": "user signed up",
                            "timestamp": datetime(2020, 1, 2, 14),
                            "properties": {"$current_url": f"https://analytickit.com/blog/{current_url_letter}"},
                        }
                    )
                        ...
                        "properties": [
                            {
                                ...
                                "operator": "icontains",
                                "type": "event",
                                "value": "https://analytickit.com/docs",
                            }
                        ],
                    },
            ...
            assert_funnel_breakdown_result_is_correct(
                result[0],
                [
                    FunnelStepResult(name="user signed up", count=1, breakdown=["https://analytickit.com/docs/x"]),
                    FunnelStepResult(
                        name="paid",
                        count=1,
                        average_conversion_time=691200.0,
                        median_conversion_time=691200.0,
                        breakdown=["https://analytickit.com/docs/x"],
                    ),
                ],
            )
