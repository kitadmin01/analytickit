...
from analytickit.queries.funnels.funnel_strict import ClickhouseFunnelStrict
...
class TestFunnelStrictStepsBreakdown(ClickhouseTestMixin,
                                     funnel_breakdown_test_factory(ClickhouseFunnelStrict, ClickhouseFunnelStrictActors,
                                                                   _create_event, _create_action,
                                                                   _create_person)):  # type: ignore
...
class TestFunnelStrictStepsConversionTime(ClickhouseTestMixin,
                                          funnel_conversion_time_test_factory(ClickhouseFunnelStrict,
