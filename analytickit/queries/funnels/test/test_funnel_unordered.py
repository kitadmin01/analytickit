...
from analytickit.queries.funnels.funnel_unordered import ClickhouseFunnelUnordered
from analytickit.queries.funnels.funnel_unordered_persons import ClickhouseFunnelUnorderedActors
from analytickit.queries.funnels.test.breakdown_cases import (
    FunnelStepResult,
...
class TestFunnelUnorderedStepsBreakdown(ClickhouseTestMixin, funnel_breakdown_test_factory(ClickhouseFunnelUnordered,
...
class TestFunnelUnorderedStepsConversionTime(ClickhouseTestMixin,
                                             funnel_conversion_time_test_factory(ClickhouseFunnelUnordered,
                                                                                 ClickhouseFunnelUnorderedActors,
                                                                                 _create_event,
                                                                                 _create_person)):  # type: ignore
    maxDiff = None
