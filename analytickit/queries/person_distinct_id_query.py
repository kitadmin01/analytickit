...
from analytickit.models.async_migration import is_async_migration_complete
from analytickit.models.person.sql import GET_TEAM_PERSON_DISTINCT_IDS, GET_TEAM_PERSON_DISTINCT_IDS_NEW_TABLE
from analytickit.settings import BENCHMARK, TEST

using_new_table = TEST or BENCHMARK


def get_team_distinct_ids_query(team_id: int) -> str:
    from analytickit.client import substitute_params
