...
from analytickit.constants import TREND_FILTER_TYPE_ACTIONS
from analytickit.models import Entity
from analytickit.models.action.util import format_entity_filter
...
class SessionRecordingList(EventQuery):
    ...
    _event_and_recording_match_conditions_clause = """
        (
            -- If there is a session_id on the event, then it is from analytickit-js
            ...
            -- from a analytickit-client that doesn't support session (e.g. backend client)
