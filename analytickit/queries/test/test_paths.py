...
def paths_test_factory(paths):
    class TestPaths(ClickhouseTestMixin, APIBaseTest):
        ...
        def test_paths_properties_filter(self):
            ...
            _create_event(properties={"$current_url": "/"}, distinct_id="person_3", event="$pageview",
                          team=self.team, ),
            _create_event(properties={"$current_url": "/"}, distinct_id="person_4", event="$pageview",
                          team=self.team, ),
            _create_event(
        ...
        def test_paths_start(self):
            ...
            _create_event(properties={"$current_url": "/"}, distinct_id="person_1", event="$pageview",
                          team=self.team, ),
            _create_event(
                properties={"$current_url": "/about/"}, distinct_id="person_1", event="$pageview", team=self.team,
            ),
            _create_event(properties={"$current_url": "/"}, distinct_id="person_2", event="$pageview",
                          team=self.team, ),
            _create_event(
