...
from analytickit.models.action.util import format_action_filter
from analytickit.models.entity import Entity
from analytickit.models.event.sql import EVENT_JOIN_PERSON_SQL
from analytickit.models.filters import Filter
from analytickit.models.filters.mixins.utils import cached_property
from analytickit.models.property import PropertyGroup
from analytickit.models.property.util import get_property_string_expr, parse_prop_grouped_clauses
from analytickit.models.team import Team
from analytickit.models.utils import PersonPropertiesMode
from analytickit.queries.breakdown_props import (
    ALL_USERS_COHORT_ID,
    format_breakdown_cohort_join_query,
    get_breakdown_cohort_name,
    get_breakdown_prop_values,
)
from analytickit.queries.column_optimizer.column_optimizer import ColumnOptimizer
from analytickit.queries.groups_join_query import GroupsJoinQuery
...
from analytickit.queries.session_query import SessionQuery
from analytickit.queries.trends.sql import (
...
from analytickit.queries.trends.util import enumerate_time_range, get_active_user_params, parse_response, process_math
from analytickit.queries.util import date_from_clause, get_time_diff, get_trunc_func_ch, parse_timestamps, \
    start_of_week_fix
...
class TrendsBreakdown:
    ...
    def get_query(self) -> Tuple[str, Dict, Callable]:
        ...
        if len(_params["values"]) == 0:
            ...
            # See https://github.com/analytickit/analytickit/pull/5674 for context.
            return (
