...
from analytickit.models.person.util import get_persons_by_uuids
...
from analytickit.queries.trends.sql import LIFECYCLE_PEOPLE_SQL, LIFECYCLE_SQL
from analytickit.queries.trends.util import parse_response
...
class Lifecycle:
    ...
    def get_people(
        ...
        from analytickit.api.person import PersonSerializer
