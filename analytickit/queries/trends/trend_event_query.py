...
from analytickit.constants import MONTHLY_ACTIVE, WEEKLY_ACTIVE, PropertyOperatorType
from analytickit.models import Entity
...
from analytickit.queries.event_query import EventQuery
from analytickit.queries.person_query import PersonQuery
from analytickit.queries.trends.util import get_active_user_params
    ...
    def get_query(self) -> Tuple[str, Dict[str, Any]]:
        _fields = (
            ...
            [
                ...
                + (
                    " ".join(
                        f", {self.EVENT_TABLE_ALIAS}.{column_name} as {column_name}" for column_name in
                        self._extra_fields
                    )
                )
