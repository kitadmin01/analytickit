"""
Django settings for analytickit project.
...
from analytickit.settings.overrides import *

from analytickit.settings.base_variables import *

from analytickit.settings.access import *
from analytickit.settings.async_migrations import *
...
from analytickit.settings.logs import *
from analytickit.settings.sentry import *
from analytickit.settings.shell_plus import *
from analytickit.settings.service_requirements import *
from analytickit.settings.statsd import *
from analytickit.settings.object_storage import *

from analytickit.settings.web import *
...
# https://analytickit.com/docs/self-host/configure/environment-variables
...
PLUGINS_PREINSTALLED_URLS: List[str] = (
    os.getenv("PLUGINS_PREINSTALLED_URLS", "https://github.com/AnalyticKit/analytickit-plugin-geoip").split(",")
    if not DISABLE_MMDB
    else []
)
