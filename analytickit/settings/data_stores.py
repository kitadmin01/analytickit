...
from analytickit.settings.base_variables import DEBUG, IS_COLLECT_STATIC, TEST
...
if TEST or DEBUG:
    ...
    PG_USER = os.getenv("PGUSER", "analytickit")
    PG_PASSWORD = os.getenv("PGPASSWORD", "analytickit")
    PG_PORT = os.getenv("PGPORT", "5432")
    PG_DATABASE = os.getenv("PGDATABASE", "analytickit")
...
CLICKHOUSE_CLUSTER = os.getenv("CLICKHOUSE_CLUSTER", "analytickit")
