...
from analytickit.settings import get_from_env
from analytickit.settings.base_variables import DEBUG, TEST
...
OBJECT_STORAGE_BUCKET = os.getenv("OBJECT_STORAGE_BUCKET", "analytickit")
...
WRITE_RECORDINGS_TO_OBJECT_STORAGE_FOR_TEAM = get_from_env(
    "WRITE_RECORDINGS_TO_OBJECT_STORAGE_FOR_TEAM", None, type_cast=int, optional=True
)

READ_RECORDINGS_FROM_OBJECT_STORAGE_FOR_TEAM = get_from_env(
    "READ_RECORDINGS_FROM_OBJECT_STORAGE_FOR_TEAM", None, type_cast=int, optional=True
)
