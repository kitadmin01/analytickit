...
from analytickit.settings.utils import get_from_env, print_warning, str_to_bool
...
if SKIP_SERVICE_VERSION_REQUIREMENTS and not (TEST or DEBUG):
    print_warning(
        ["Skipping service version requirements. This is dangerous and analytickit might not work as expected!"])
