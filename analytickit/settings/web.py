...
# :NOTE: analytickit-cloud modifies some of these values
import os
from datetime import timedelta
from typing import List

from analytickit.settings.base_variables import BASE_DIR, DEBUG, TEST
from analytickit.settings.statsd import STATSD_HOST
from analytickit.settings.utils import get_from_env, get_list, str_to_bool
...
AXES_LOCKOUT_CALLABLE = "analytickit.api.authentication.axes_locked_out"
...
MIDDLEWARE = [
    ...
    "analytickit.gzip_middleware.ScopedGZipMiddleware",
    ...
    "analytickit.health.healthcheck_middleware",
    "analytickit.middleware.ShortCircuitMiddleware",
    "analytickit.middleware.AllowIPMiddleware",
    "google.cloud.sqlcommenter.django.middleware.SqlCommenter",
    "django.contrib.sessions.middleware.SessionMiddleware",
    "corsheaders.middleware.CorsMiddleware",
    "django.middleware.common.CommonMiddleware",
    "analytickit.middleware.CsrfOrKeyViewMiddleware",
    "django.contrib.auth.middleware.AuthenticationMiddleware",
    "django.contrib.messages.middleware.MessageMiddleware",
    "django.middleware.clickjacking.XFrameOptionsMiddleware",
    "analytickit.middleware.CsvNeverCacheMiddleware",
    "whitenoise.middleware.WhiteNoiseMiddleware",
    "axes.middleware.AxesMiddleware",
    "analytickit.middleware.AutoProjectMiddleware",
    "analytickit.middleware.CHQueries",
...
ROOT_URLCONF = "analytickit.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": ["frontend/dist", "analytickit/templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "analytickit.wsgi.application"

# Social Auth

SOCIAL_AUTH_JSONFIELD_ENABLED = True
SOCIAL_AUTH_USER_MODEL = "analytickit.User"
...
SOCIAL_AUTH_PIPELINE = (
    ...
    "analytickit.api.signup.social_create_user",
...
AUTH_USER_MODEL = "analytickit.User"
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "analytickit.auth.PersonalAPIKeyAuthentication",
...
if get_from_env("RATE_LIMIT_ENABLED", False, type_cast=str_to_bool) or TEST:
    ...
    REST_FRAMEWORK["DEFAULT_THROTTLE_CLASSES"] = [
        "analytickit.rate_limit.PassThroughBurstRateThrottle",
        "analytickit.rate_limit.PassThroughSustainedRateThrottle",
    ]
    REST_FRAMEWORK["DEFAULT_THROTTLE_RATES"] = {"burst": "120/minute", "sustained": "1000/hour"}

SPECTACULAR_SETTINGS = {
    "AUTHENTICATION_WHITELIST": ["analytickit.auth.PersonalAPIKeyAuthentication"],
    "PREPROCESSING_HOOKS": ["analytickit.api.documentation.preprocess_exclude_path_format"],
    "POSTPROCESSING_HOOKS": ["analytickit.api.documentation.custom_postprocessing_hook"],
}

EXCEPTIONS_HOG = {
    "EXCEPTION_REPORTING": "analytickit.exceptions.exception_reporting",
}
...
CSRF_COOKIE_NAME = "analytickit_csrftoken"

# see analytickit.gzip_middleware.ScopedGZipMiddleware
