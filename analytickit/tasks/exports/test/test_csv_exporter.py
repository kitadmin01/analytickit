...
from analytickit.storage.object_storage import ObjectStorageError
from analytickit.tasks.exports import csv_exporter
from analytickit.tasks.exports.csv_exporter import add_query_params
...
class TestCSVExporter(APIBaseTest):
    ...
    def patched_request(self):
        with patch("analytickit.tasks.exports.csv_exporter.requests.request") as patched_request:
            mock_response = Mock()
            mock_response.status_code = 200
            # API responses copied from https://github.com/analytickit/analytickit/runs/7221634689?check_suite_focus=true
    ...
    @patch("analytickit.tasks.exports.csv_exporter.statsd")
