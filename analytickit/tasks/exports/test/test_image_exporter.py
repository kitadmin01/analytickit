...
from analytickit.models import ExportedAsset, Insight
...
from analytickit.tasks.exports import image_exporter
from analytickit.test.base import APIBaseTest

TEST_BUCKET = "Test-Exports"


@patch("analytickit.tasks.exports.image_exporter.synchronously_update_insight_cache")
@patch("analytickit.tasks.exports.image_exporter._screenshot_asset")
...
class TestImageExporter(APIBaseTest):
    ...
    def test_image_exporter_writes_to_object_storage_when_object_storage_write_fails(
            self, mocked_object_storage_write, mocked_uuidt, mock_update_cache, mock_screenshot, mock_file_read,
            mock_remove
    ) -> None:
        mocked_uuidt.return_value = "a-guid"
