...
from analytickit.models import Insight, Organization
        ...
        def test_calculate_usage(self) -> None:
            ...
            with freeze_time("2020-08-01"):
                ...
                Insight.objects.create(
                    ...
                    filters={
                        "events": [{"id": "$pageview"}],
                        "properties": [{"key": "$current_url", "value": "https://analytickit.com"}],
                    },
                )
                create_event(
                    distinct_id="test",
                    team=self.team,
                    event="$pageview",
                    properties={"$current_url": "https://analytickit.com"},
                )
            with freeze_time("2020-10-01"):
                ...
                Insight.objects.create(
                    ...
                    filters={
                        "events": [{"id": "$pageview"}],
                        "properties": [{"key": "$current_url", "value": "https://analytickit2.com"}],
                    },
                )
                Insight.objects.create(
                    team=self.team,
                ...
                create_event(
                    ...
                    team=self.team,
                    event="$pageview",
                    properties={"$current_url": "https://analytickit2.com"},
                )
