...
from analytickit.tasks.check_clickhouse_schema_drift import check_clickhouse_schema_drift, get_clickhouse_schema_drift
...
@patch("analytickit.client.ch_pool.get_client")
