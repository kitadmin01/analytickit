...
from analytickit.models.messaging import MessagingRecord, get_email_hash
from analytickit.models.organization import OrganizationInvite, OrganizationMembership
from analytickit.models.plugin import Plugin, PluginConfig
from analytickit.tasks.email import (
...
from analytickit.test.base import APIBaseTest, ClickhouseTestMixin
...
@patch("analytickit.tasks.email.EmailMessage")
class TestEmail(APIBaseTest, ClickhouseTestMixin):
    ...
    def setUpTestData(cls) -> None:
        ...
        create_org_team_and_user("2022-01-01 00:00:00", "too_late_user@analytickit.com")
        create_org_team_and_user("2022-01-02 00:00:00", "ingested_event_in_range_user@analytickit.com",
                                 ingested_event=True)
        create_org_team_and_user("2022-01-03 00:00:00", "too_early_user@analytickit.com")

    def test_send_invite(self, MockEmailMessage: MagicMock) -> None:
        mocked_email_messages = mock_email_messages(MockEmailMessage)

        org, user = create_org_team_and_user("2022-01-02 00:00:00", "admin@analytickit.com")
        invite = OrganizationInvite.objects.create(organization=org, created_by=user,
                                                   target_email="test@analytickit.com")
    ...
    def test_send_member_join(self, MockEmailMessage: MagicMock) -> None:
        ...
        user = User.objects.create_and_join(
            organization=org, email="new-user@analytickit.com", password=None,
    ...
    def test_send_canary_email(self, MockEmailMessage: MagicMock) -> None:
        mocked_email_messages = mock_email_messages(MockEmailMessage)
        send_canary_email("test@analytickit.com")
    ...
    def test_send_async_migration_complete_email(self, MockEmailMessage: MagicMock) -> None:
        ...
        User.objects.create(email="staff-user@analytickit.com", password="password", is_staff=True)
    ...
    @patch("analytickitanalytics.feature_enabled", return_value=True)
    def test_first_email_sent_to_correct_users_only_once(self, __: Any, MockEmailMessage: MagicMock) -> None:
        ...
        in_range_org, user = create_org_team_and_user("2022-01-02 00:00:00", "in_range_user@analytickit.com")
        User.objects.create_and_join(
            first_name="Test User",
            organization=in_range_org,
            email="in_range_user_not_admin@analytickit.com",
            password=None,
            level=OrganizationMembership.Level.MEMBER,
        )
        ...
        with freeze_time("2022-01-03 15:00:00"):
            ...
            self.assertEqual(
                ...
                set(
                    [get_email_hash("in_range_user_not_admin@analytickit.com"),
                     get_email_hash("in_range_user@analytickit.com")]
                ),
            )
