...
from analytickit.models.activity_logging.activity_log import ActivityLog, Change, Detail, log_activity
...
class TestActivityLogModel(BaseTest):
    ...
    def test_can_not_save_if_there_is_neither_a_team_id_nor_an_organisation_id(self) -> None:
        ...
        self.assertIn(
            'new row for relation "analytickit_activitylog" violates check constraint "must_have_team_or_organization_id',
