...
class FixingDashboardTilesTestCase(TestMigrations):
    ...
    def setUpBeforeMigration(self, apps):
        ...
        Dashboard = apps.get_model("analytickit", "Dashboard")
        Insight = apps.get_model("analytickit", "Insight")
        Team = apps.get_model("analytickit", "Team")
        DashboardTile = apps.get_model("analytickit", "DashboardTile")
    ...
    def test_migrate_to_create_tiles(self):
        ...
        """
        DashboardTile = self.apps.get_model("analytickit", "DashboardTile")  # type: ignore
    ...
    def tearDown(self):
        Team = self.apps.get_model("analytickit", "Team")  # type: ignore
        Dashboard = self.apps.get_model("analytickit", "Dashboard")  # type: ignore
        Insight = self.apps.get_model("analytickit", "Dashboard")  # type: ignore
