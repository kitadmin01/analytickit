...
from analytickit.models import Plugin, PluginConfig
from analytickit.models.plugin import PluginLogEntrySource, PluginLogEntryType, fetch_plugin_log_entries
...
def create_plugin_log_entry(
    ...
    from analytickit.clickhouse.plugin_log_entries import INSERT_PLUGIN_LOG_ENTRY_SQL
