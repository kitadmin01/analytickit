...
class TestUserAPI(APIBaseTest):
    ...
    @patch("analytickit.rate_limit.PassThroughBurstRateThrottle.get_rate", return_value="5/minute")
    @patch("analytickit.rate_limit.incr")
    ...
    @patch("analytickit.rate_limit.PassThroughSustainedRateThrottle.get_rate", return_value="5/hour")
    @patch("analytickit.rate_limit.incr")
