...
from analytickit.settings.utils import get_from_env
...
class TestAbsoluteUrls(TestCase):
    def test_format_absolute_url(self) -> None:
        ...
        absolute_urls_test_cases = [
            ...
            ("/api/path", "https://my-amazing.site/base_url", "https://my-amazing.site/base_url/api/path"),
            (regression_11204, "https://dpa.analytickit.com", f"https://dpa.analytickit.com/{regression_11204}",),
            ("https://dpa.analytickit.com", "https://dpa.analytickit.com", "https://dpa.analytickit.com"),
            (
                "https://dpa.analytickit.com/some/path?=something",
                "https://dpa.analytickit.com",
                "https://dpa.analytickit.com/some/path?=something",
            ),
            (
                "an.attackers.domain.com/bitcoin-miner.exe",
                "https://dpa.analytickit.com",
                "https://dpa.analytickit.com/an.attackers.domain.com/bitcoin-miner.exe",
            ),
...
class TestGeneralUtils(TestCase):
    def test_mask_email_address(self):
        self.assertEqual(mask_email_address("hey@analytickit.com"), "h*y@analytickit.com")
        self.assertEqual(mask_email_address("richard@gmail.com"), "r*****d@gmail.com")
        self.assertEqual(
            mask_email_address("m@analytickit.com"), "*@analytickit.com"
        )  # one letter emails are masked differently
        self.assertEqual(mask_email_address("test+alias@analytickit.com"), "t********s@analytickit.com")
...
class TestLoadDataFromRequest(TestCase):
    ...
    @patch("analytickit.utils.configure_scope")
    ...
    @patch("analytickit.utils.gzip")
    def test_can_decompress_gzipped_body_received_with_no_compression_flag(self, patched_gzip):
        # see https://sentry.io/organizations/analytickit2/issues/3136510367
