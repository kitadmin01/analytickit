...
from analytickit.health import is_clickhouse_connected, is_kafka_connected
from analytickit.models import Organization, User
from analytickit.models.integration import SlackIntegration
...
def security_txt(request):
    SECURITY_TXT_CONTENT = """
        Contact: mailto:engineering@analytickit.com
        Hiring: https://analytickit.com/careers
