...
Cypress.Commands.add('analytickit', () => cy.window().then(($window) => $window.analytickit))

Cypress.Commands.add('analytickitInit', (options) => {
    $captures = []
    $fullCaptures = []

    cy.analytickit().invoke('init', 'test_token', {
