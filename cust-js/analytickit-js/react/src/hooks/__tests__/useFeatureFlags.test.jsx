...
import { AnalyticKitProvider } from '../../context'
...
describe('useFeatureFlags hook', () => {
    given('renderProvider', () => ({ children }) => (
        <AnalyticKitProvider client={given.analytickit}>{children}</AnalyticKitProvider>
    ))
    ...
    it('should not refresh feature flags on an interval if no refreshInterval is provided', () => {
        ...
        act(() => {
            const reloadFeatureFlags = given.analytickit.featureFlags.reloadFeatureFlags
