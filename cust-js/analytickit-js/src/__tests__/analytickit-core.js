import { init_as_module, AnalyticKit } from '../analytickit-core'
...
describe('identify()', () => {
    ...
    describe('invalid id passed', () => {
        ...
        it('does not update user', () => {
            ...
            expect(console.error).toHaveBeenCalledWith('Unique user id has not been set in analytickit.identify')
        })
    })
...
describe('capture()', () => {
    ...
    it('errors with undefined event name', () => {
        ...
        expect(console.error).toHaveBeenCalledWith('No event name provided to analytickit.capture')
    })
...
describe('init()', () => {
    given('subject', () => () => given.lib._init('analytickit', given.config, 'testhog'))
...
describe('group()', () => {
    ...
    given('overrides', () => ({
        persistence: new AnalyticKitPersistence(given.config),
        capture: jest.fn(),
        _captureMetrics: {
            incr: jest.fn(),
        },
