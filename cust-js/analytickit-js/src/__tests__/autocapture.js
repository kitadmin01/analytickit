...
describe('Autocapture system', () => {
    ...
    describe('afterDecideResponse()', () => {
        given('subject', () => () => autocapture.afterDecideResponse(given.decideResponse, given.analytickit))
        ...
        it('should NOT call _addDomEventHandlders when the token has already been initialized', () => {
            autocapture.afterDecideResponse(given.decideResponse, given.analytickit)
