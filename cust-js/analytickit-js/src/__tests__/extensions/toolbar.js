...
describe('Toolbar', () => {
    ...
    beforeEach(() => {
        ...
        delete window['_analyticKitToolbarLoaded']
    })
    ...
    describe('maybeLoadEditor', () => {
        ...
        it('should work if calling editor params `__analytickit`', () => {
            given('hashParams', () => ({
                access_token: given.accessToken,
                __analytickit: encodeURIComponent(JSON.stringify(given.editorParams)),
                expires_in: 3600,
            }))
