import { AnalyticKitFeatureFlags, parseFeatureFlagDecideResponse } from '../analytickit-featureflags'
jest.useFakeTimers()
...
describe('featureflags', () => {
    ...
    given('featureFlags', () => new AnalyticKitFeatureFlags(given.instance))
