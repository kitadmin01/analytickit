...
describe(`GDPR utils`, () => {
    ...
    describe(`addOptOutCheckAnalyticKitLib`, () => {
        const captureEventName = `єνєηт`
        const captureProperties = { '𝖕𝖗𝖔𝖕𝖊𝖗𝖙𝖞': `𝓿𝓪𝓵𝓾𝓮` }
        let getConfig, capture, analytickitLib
        ...
        function setupMocks(getConfigFunc, silenceErrors = false) {
            ...
            analytickitLib.capture = gdpr.addOptOutCheck(analytickitLib, capture, silenceErrors)
        }
        ...
        forPersistenceTypes(function (persistenceType) {
            it(`should call the wrapped method if the user is neither opted in or opted out`, () => {
                TOKENS.forEach((token) => {
                    ...
                    analytickitLib.capture(captureEventName, captureProperties)
            ...
            it(`should not invoke the callback directly if the user is neither opted in or opted out`, () => {
                TOKENS.forEach((token) => {
                    ...
                    analytickitLib.capture(captureEventName, captureProperties, callback)
    ...
    describe(`addOptOutCheckAnalyticKitPeople`, () => {
        const setPropertyName = '𝖕𝖗𝖔𝖕𝖊𝖗𝖙𝖞'
        const setPropertyValue = `𝓿𝓪𝓵𝓾𝓮`
        let getConfig, set, analytickitPeople, analytickitLib
        ...
        function setupMocks(getConfigFunc, silenceErrors = false) {
            ...
            analytickitPeople.set = gdpr.addOptOutCheck(analytickitLib, set, silenceErrors)
        }
        ...
        forPersistenceTypes(function (persistenceType) {
            it(`should call the wrapped method if the user is neither opted in or opted out`, () => {
                TOKENS.forEach((token) => {
                    ...
                    analytickitPeople.set(setPropertyName, setPropertyValue)
            ...
            it(`should not invoke the callback directly if the user is neither opted in or opted out`, () => {
                TOKENS.forEach((token) => {
                    ...
                    analytickitPeople.set(setPropertyName, setPropertyValue, callback)
