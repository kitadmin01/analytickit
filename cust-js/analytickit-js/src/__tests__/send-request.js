...
describe('xhr', () => {
    ...
    given('xhrParams', () => ({
        url: 'https://any.analytickit-instance.com',
        data: '',
        headers: {},
        options: {},
        captureMetrics: {
...
describe('adding query params to analytickit API calls', () => {
    given('subject', () => () => addParamsToURL(given.analytickitURL, given.urlQueryArgs, given.parameterOptions))
    given('analytickitURL', () => 'https://any.analytickit-instance.com')
    given('urlQueryArgs', () => ({}))
