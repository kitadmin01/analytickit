...
export const parseFeatureFlagDecideResponse = (response: DecideResponse, persistence: AnalyticKitPersistence) => {
...
export class AnalyticKitFeatureFlags {
    instance: AnalyticKit
    ...
    constructor(instance: AnalyticKit) {
    ...
    getFlagVariants(): Record<string, string | boolean> {
        ...
        if (!this._override_warning) {
            console.warn('[AnalyticKit] Overriding feature flags!', {
                enabledFlags,
                overriddenFlags,
                finalFlags,
            })
     ...
     * 3. Don't call this during initial load (as /decide will be called instead), see analytickit-core.js
     */
     ...
     * ### Usage:
     *
     *     if(analytickit.getFeatureFlag('my-flag') === 'some-variant') { // do something }
     *
     ...
     * ### Usage:
     *
     *     - analytickit.feature_flags.override(false)
     *     - analytickit.feature_flags.override(['beta-feature'])
     *     - analytickit.feature_flags.override({'beta-feature': 'variant', 'other-feature': True})
     *
