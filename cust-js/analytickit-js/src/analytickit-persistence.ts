...
import { PersistentStore, AnalyticKitConfig, Properties } from './types'
...
/**
 * AnalyticKit Persistence Object
 * @constructor
 */
export class AnalyticKitPersistence {
    props: Properties
    ...
    constructor(config: AnalyticKitConfig) {
        ...
        if (config['persistence_name']) {
            ...
            this.name = 'ph_' + token + '_analytickit'
        }
    ...
    update_config(config: AnalyticKitConfig): void {
