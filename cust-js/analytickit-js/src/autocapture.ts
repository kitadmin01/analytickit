...
const autocapture = {
    ...
    _captureEvent: function (e: Event, instance: AnalyticKit): boolean | void {
    ...
    _addDomEventHandlers: function (instance: AnalyticKit): void {
    ...
    init: function (instance: AnalyticKit): void {
        this.rageclicks = new RageClick(instance)
    },

    afterDecideResponse: function (response: DecideResponse, instance: AnalyticKit): void {
