import { AnalyticKitPersistence, SESSION_ID } from './analytickit-persistence'
import { sessionStore } from './storage'
import { _UUID } from './utils'
import { AnalyticKitConfig } from './types'
...
export class SessionIdManager {
    ...
    constructor(config: Partial<AnalyticKitConfig>, persistence: AnalyticKitPersistence) {
