...
export interface AnalyticKitConfig {
    api_host: string
    api_method: string
    ...
    cookie_name: string
    loaded: (analytickit_instance: AnalyticKit) => void
...
export interface GDPROptions {
    capture?: (
        ...
        properties: Properties,
        options: CaptureOptions
    ) => void /** function used for capturing a AnalyticKit event to record the opt-in action */
