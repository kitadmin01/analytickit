...
var core_interaction = createCommonjsModule(function (module) {
...
var plugin_crosshair = {
	...
	getOption: function (chart, category, name) {
		return helpers$1.getValueOrDefault(
	...
	doZoom: function (chart, start, end) {
		...
		// notify delegate
		var beforeZoomCallback = helpers$1.getValueOrDefault(
...
var crosshair = plugin_crosshair;
