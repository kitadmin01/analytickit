...
RecordStream.prototype._write = function _write(chunk, enc, cb) {
    if (!Buffer.isBuffer(chunk) && typeof chunk !== 'string') chunk = encodeRow(chunk, this.format)
...
RecordStream.prototype._destroy = function _destroy(err, cb) {
    process.nextTick(
        function () {
            RecordStream.super_.prototype._destroy.call(
                this,
                err,
                function (destroyErr) {
...
RecordStream.prototype.end = function end(chunk, enc, cb) {
    RecordStream.super_.prototype.end.call(
        this,
        chunk,
        enc,
        function () {
