...
var Slider = _interopDefault(require('rc-slider/lib/Slider'));
var rrweb = require('rrweb');
var screenfull = _interopDefault(require('screenfull'));
var useLocalStorageState = _interopDefault(require('use-local-storage-state'));
...
require('rrweb/dist/rrweb.min.css');
...
function IconSeekBack(_ref2) {
  ...
  return React__default.createElement(BaseIcon, {
    onClick: onClick,
    className: className
...
function PlayPauseOverlay(_ref) {
  ...
  }, playing ? React__default.createElement(IconPlay, {
...
function PlayerFrame(_ref) {
  var replayer = _ref.replayer,
      frame = _ref.frame;
  var replayDimensionRef = React.useRef();
  React.useEffect(function () {
    if (!replayer) {
      return;
    }
...
var Player = React.forwardRef(function Player(_ref, ref) {
  ...
  var _useState4 = React.useState(defaultTime),
      meta = _useState4[0],
  ...
  var replayer = React.useRef(null);
  var timer = React.useRef();
  var setCurrentTimeDebounced = useDebounce.useDebouncedCallback(setCurrentTime, 10, {
    maxWait: 100
  }).callback;
  var onPlayerTimeChangeDebounced = useDebounce.useDebouncedCallback(onPlayerTimeChange || NOOP, 300, {
    maxWait: 1000
  }).callback;
  React.useEffect(function () {
    if (frame.current) {
      replayer.current = new rrweb.Replayer(events, {
        root: frame.current,
        skipInactive: true,
        triggerFocus: false,
        speed: speed
  ...
  }, React__default.createElement(PlayerFrame, {
    replayer: replayer.current,
    frame: frame
  }), React__default.createElement("div", {
    className: 'ph-rrweb-overlay'
  }, skipping && React__default.createElement("div", {
    className: 'ph-rrweb-skipping'
  }, "Skipping inactivity..."), React__default.createElement(PlayPauseOverlay, {
    playing: playing
  }))), React__default.createElement("div", {
  ...
  }, React__default.createElement("div", null, React__default.createElement(Tooltip, {
    placement: 'top',
    overlayInnerStyle: {
      minHeight: 'auto'
    },
    overlay: 'Play/pause (space)'
  }, React__default.createElement("span", null, playing ? React__default.createElement(IconPause, {
    onClick: togglePlayPause,
  ...
  }, React__default.createElement("span", null, React__default.createElement(IconSeekBack, {
    onClick: seekBack
  }))), React__default.createElement("span", {
    className: 'ph-rrweb-timestamp'
  }, formatTime(currentTime), " /", ' ', formatTime(meta.totalTime))), React__default.createElement("div", {
    style: {
      justifyContent: 'center'
    }
  }, onPrevious && React__default.createElement(Tooltip, {
    placement: 'top',
    overlayInnerStyle: {
      minHeight: 'auto'
    },
    overlay: 'Previous recording (a)'
  }, React__default.createElement("span", null, React__default.createElement(IconStepBackward, {
    onClick: onPrevious
  }))), onNext && React__default.createElement(Tooltip, {
    placement: 'top',
    overlayInnerStyle: {
      minHeight: 'auto'
    },
    overlay: 'Next recording (d)'
  }, React__default.createElement("span", null, React__default.createElement(IconStepForward, {
    onClick: onNext
  })))), React__default.createElement("div", {
    style: {
  ...
  }), screenfull.isEnabled && React__default.createElement(Tooltip, {
    placement: 'top',
    overlayInnerStyle: {
      minHeight: 'auto'
    },
    overlay: 'Full screen (f)'
  }, React__default.createElement("span", null, React__default.createElement(IconFullscreen, {
