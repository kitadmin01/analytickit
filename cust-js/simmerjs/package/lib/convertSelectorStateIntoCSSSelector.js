...
function _default(state) {
  let depth = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : state.stack.length;
  return (0, _lodash.default)(state.stack.reduceRight((selectorSegments, elementState) => {
