...
from dpa.api.test.base import APILicensedTest
...
class TestProjectEnterpriseAPI(APILicensedTest):
    ...
    def test_list_teams_restricted_ones_hidden(self):
        ...
        # 9 (above) + 2 below:
        # Used for `metadata`.`taxonomy_set_events_count`: SELECT COUNT(*) FROM "dpa_enterpriseeventdefinition" WHERE ...
        #  Used for `metadata`.`taxonomy_set_properties_count`: SELECT COUNT(*) FROM "dpa_enterprisepropertydefinition" WHERE ...
