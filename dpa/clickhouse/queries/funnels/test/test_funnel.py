...
from dpa.clickhouse.queries.funnels.test.breakdown_cases import funnel_breakdown_group_test_factory


class TestFunnelBreakdown(
    ClickhouseTestMixin,
    funnel_breakdown_test_factory(
        ClickhouseFunnel, ClickhouseFunnelActors, _create_event, _create_action, _create_person
    ),
