...
class EnterpriseEventDefinition(EventDefinition):
    owner = models.ForeignKey(
        "analytickit.User", null=True, on_delete=models.SET_NULL, related_name="event_definitions"
    )
    description: models.TextField = models.TextField(blank=True, null=True, default="")
    updated_at: models.DateTimeField = models.DateTimeField(auto_now=True)
    updated_by = models.ForeignKey("analytickit.User", null=True, on_delete=models.SET_NULL, blank=True)
    ...
    verified_by = models.ForeignKey(
        "analytickit.User", null=True, on_delete=models.SET_NULL, blank=True, related_name="verifying_user",
    )
