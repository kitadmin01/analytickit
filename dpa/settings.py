"""
Django settings for analytickit Enterprise Edition.
"""
import os
from typing import Dict, List

from analytickit.settings import AUTHENTICATION_BACKENDS, SITE_URL, get_from_env

# Zapier REST hooks
HOOK_EVENTS: Dict[str, str] = {
    # "event_name": "App.Model.Action" (created/updated/deleted)
    "action_defined": "analytickit.Action.created_custom",
    "action_performed": "analytickit.Action.performed",
    "annotation_created": "analytickit.Annotation.created_custom",
}
HOOK_FINDER = "dpa.models.hook.find_and_fire_hook"
HOOK_DELIVERER = "dpa.models.hook.deliver_hook_wrapper"

# SSO
AUTHENTICATION_BACKENDS = AUTHENTICATION_BACKENDS + [
    "dpa.api.authentication.MultitenantSAMLAuth",
...
SOCIAL_AUTH_SAML_ORG_INFO = {
    "en-US": {"name": "analytickit", "displayname": "analytickit", "url": "https://analytickit.com"}
}
SOCIAL_AUTH_SAML_TECHNICAL_CONTACT = {"givenName": "analytickit Support", "emailAddress": "hey@analytickit.com"}
