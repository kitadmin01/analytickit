...
from dpa.tasks.subscriptions.subscription_utils import DEFAULT_MAX_ASSET_COUNT, generate_assets
from dpa.tasks.test.subscriptions.subscriptions_test_factory import create_subscription


@patch("dpa.tasks.subscriptions.subscription_utils.group")
@patch("dpa.tasks.subscriptions.subscription_utils.exporter.export_asset")
