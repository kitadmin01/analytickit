...
class TagsTestCase(TestMigrations):
    ...
    def setUpBeforeMigration(self, apps):
        EnterpriseEventDefinition = apps.get_model("dpa", "EnterpriseEventDefinition")
        EnterprisePropertyDefinition = apps.get_model("dpa", "EnterprisePropertyDefinition")
    ...
    def test_tags_migrated(self):
        ...
        EnterpriseEventDefinition = self.apps.get_model("dpa", "EnterpriseEventDefinition")  # type: ignore
        EnterprisePropertyDefinition = self.apps.get_model("dpa", "EnterprisePropertyDefinition")  # type: ignore
