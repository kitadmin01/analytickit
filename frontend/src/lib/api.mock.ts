...
export const MOCK_DEFAULT_TEAM: TeamType = {
    ...
    app_urls: ['https://analytickit.com/', 'https://dpa.analytickit.com'],
    ...
    test_account_filters: [
        { key: 'email', type: 'person', value: 'analytickit.com', operator: PropertyOperator.NotIContains },
    ],
...
export const MOCK_DEFAULT_BASIC_USER: UserBasicType = {
    ...
    first_name: 'John',
    email: 'john.doe@analytickit.com',
}
