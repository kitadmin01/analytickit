...
{
user: {first_name: 'Paul', email: 'paul@analytickit.com'
},
activity: 'updated',
scope: ActivityScope.FEATURE_FLAG,
item_id: '1353',
...
{
user: {first_name: 'Alex Kim', email: 'alex@analytickit.com'
},
activity: 'updated',
scope: ActivityScope.FEATURE_FLAG,
item_id: '1474',
...
{
user: {first_name: 'Neil', email: 'neil@analytickit.com'
},
activity: 'updated',
scope: ActivityScope.FEATURE_FLAG,
item_id: '1846',
...
{
user: {first_name: 'Cameron', email: 'cameron@analytickit.com'
},
activity: 'created',
...
{
user: {first_name: 'Michael', email: 'michael@analytickit.com'
},
activity: 'updated',
scope: ActivityScope.INSIGHT,
item_id: '738061',
