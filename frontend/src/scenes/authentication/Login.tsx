...
export const ERROR_MESSAGES: Record<string, string | JSX.Element> = {
    ...
    invalid_sso_provider: (
        <>
            ...
            <a href="https://analytickit.com/sso" target="_blank">
                https://analytickit.com/sso
            </a>{' '}
            for details.
        </>
    ),
    ...
    jit_not_enabled:
        'We could not find an account with your email address and your BusinessProfile does not support automatic enrollment. Please contact your administrator for an invite.',
}
