...
const CommunityEngagementTable: React.FC<CommunityEngagementTableProps> = ({ onEditCampaign }) => {
    ...
    const columns = [
        {
            ...
            sorter: (a: CommunityEngagement, b: CommunityEngagement) =>
    ...
    return (
        <>
            ...
            <LemonTable columns={columns} dataSource={data} loading={loading} />
            <CampaignModal
            ...
            {selectedCampaignId && isAnalyticsModalVisible && <CryptoDashboard campaignId={selectedCampaignId} />}
        </>
    )
}
