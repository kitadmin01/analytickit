...
const CryptoDashboard: React.FC<DashboardProps> = ({ campaignId }) => {
    ...
    const totalContractCallsData = campaignData.map((item) => ({
        timestamp: item.creation_ts,
        value: item.total_contract_calls,
    }))
    const totalTokenTransferData = campaignData.map((item) => ({
        timestamp: item.creation_ts,
        value: item.tot_tokens_transferred,
    }))
    ...
    const totalTokTransferValueData = campaignData.map((item) => ({
        timestamp: item.creation_ts,
        value: item.token_transfer_value,
    }))
    const aveTokTransferValueData = campaignData.map((item) => ({
        timestamp: item.creation_ts,
        value: item.ave_token_transfer_value,
    }))
