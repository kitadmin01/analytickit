...
function RNInstallSnippet(): JSX.Element {
    return (
        <CodeSnippet language={Language.Bash}>
            {'yarn add analytickit-react-native\n\nyarn react-native link\n\n# for iOS\ncd ios\npod install'}
        </CodeSnippet>
    )
}
...
function RNSetupSnippet(): JSX.Element {
    ...
    return (
        <CodeSnippet language={Language.JSX}>
            {"import analytickit from 'analytickit-react-native'\n\nawait analytickit.setup('" +
                currentTeam?.api_token +
                "', {\n\t// analytickit API host\n\thost: '" +
                url +
...
function RNCaptureSnippet(): JSX.Element {
    return <CodeSnippet language={Language.JSX}>{"analytickit.capture('test-event')"}</CodeSnippet>
}
