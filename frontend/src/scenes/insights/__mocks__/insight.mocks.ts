exportconstsampleRetentionPeopleResponse = {
result:[
{
person: {
id: 195158300,
name: 'test_user@analytickit.com',
distinct_ids: ['1234'],
properties: {
$os: 'Mac OS X',
email: 'test_user@analytickit.com',
},
is_identified: true,
