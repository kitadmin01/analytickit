...
export function OptOutCapture(): JSX.Element {
    ...
    return (
        <div>
            <p>
                analytickit uses analytickit (unsurprisingly!) to capture information about how people are using the product. We
                believe that product analytics is crucial to making analytickit the most useful it can be, for everyone.
            </p>
            <p>
