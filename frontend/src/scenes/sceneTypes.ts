...
export interface SceneConfig {
    ...
    name?: string
    /** Route should only be accessed when logged out (N.B. should be added to analytickit/urls.py too) */
    onlyUnauthenticated?: boolean
    /** Route **can** be accessed when logged out (i.e. can be accessed when logged in too; should be added to analytickit/urls.py too) */
