...
[default mocks](https://github.com/analytickit/analytickit/blob/master/frontend/src/mocks/handlers.ts#L7) are shared between storybook and jest tests.
...
useStorybookMocks({
    get: {
        ...
        '/api/projects/:team/insights': (req, _, ctx) => {
