...
body {
    font:
        ...
        sans-serif / 18px;
    background: #333;
    background: #333 url(http://www.ng4a.com/wp-content/uploads/2010/09/9090981.png) repeat-y scroll center top;
}
a,
#search input,
#header h1 a,
...
.video-right h2 {
    font:
        ...
        arial,
        helvetica,
        sans-serif bold !important / normal;
}
.video-right h2,
.post h2,
h2.commh2 {
...
.video-right h3 {
    font:
        18px arial,
        helvetica,
        sans-serif normal !important bold / 20px;
}
.video-right h3,
.archivefeed {
    padding-bottom: 0;
...
.post-alt blog {
    background: url(http://gs-shoping.net/blog/wp-content/uploads/2010/04/item_list_back.gif) repeat-x right top;
}
.navigation {
    margin-bottom: -30px;
    padding: 15px 0;
