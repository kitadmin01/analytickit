...
#topnav div.search fieldset legend {
    display: none;
}
...
#links div.block {
    background: #fff url('/images/cbl.gif') bottom left no-repeat;
}
#links div.title {
    background: #f60 url('/images/ctl_grey.png') top left no-repeat;
}
...
div#slashboxes div.block div.title h4 a {
    color: #fff;
}
div#slashboxes div.block div.title h4 a:visited {
    color: #fff;
}
...
div#links div.block div.content ul li a:hover {
    background: #ef8218 url(//images.slashdot.org/link-arrow.gif) no-repeat right center;
    color: #fff;
}
...
/* General */
.generaltitle {
    background: url('/images/article-title-orange-bg.png') #ef8218 xrepeat-x;
}
...
#journalslashdot .journaldate {
    font-weight: bold;
}
#journalslashdot .title {
    margin: 0 0 0 0.6em;
    padding: 0;
    float: left;
}
...
#journalslashdot .intro {
    padding: 1em 0 2em 3.7em;
}
#journalslashdot div.storylinks {
    margin: 0;
    padding: 0;
    background: transparent;
    font-size: 65%;
}
#journalslashdot div.storylinks ul {
    margin: 0;
    padding: 0;
    background: transparent;
}
#journalslashdot div.storylinks ul li {
    margin: 0;
    padding: 0;
    border: none;
    font-family: geneva, verdana, sans-serif;
}
#journalslashdot div.storylinks ul li a {
    padding: 0 0.4em 0 1em;
    border-left: 1px solid #000;
}
#journalslashdot div.storylinks ul li.edit a,
#journalslashdot div.storylinks ul li.discussion a,
#journalslashdot div.storylinks ul li.journalid a {
    border: none;
}
#journalslashdot .journalpage {
    font-size: 65.5%;
    font-family: geneva, verdana, sans-serif;
    text-align: right;
}
#journalgrey .journaldate {
    font-weight: bold;
    background: #eee;
}
#journalgrey .details {
...
#journalgrey div.storylinks,
#journalblue div.storylinks {
    background: transparent;
}
#journalgrey div.storylinks ul,
#journalblue div.storylinks ul {
    background: transparent;
}
#journalgrey .body,
#journalblue .body {
...
#journalblue div.storylinks ul li,
#journalgrey div.storylinks ul li {
    border: none;
    margin: 0;
    padding: 0;
}
#journalblue .journaldate {
    background: #369;
    font-weight: bold;
    padding: 3px;
}
...
div.briefarticle a span.expanded {
    width: 15px;
    background: url(//images.barrapunto.com/login-arrow-expanded.gif) no-repeat 0 50%;
}
div.briefarticle a span,
div.briefarticle a span.condensed {
    width: 15px;
    background: url(//images.barrapunto.com/login-arrow-collapsed.gif) no-repeat 0 50%;
}
...
div#user-section ul li a:visited {
    color: #fff;
}
...
@media all and (min-width: 0px) {
    ...
    head ~ body div#user-section div#loginform {
        height: 0;
    }
}
...
.indexhead div.content {
    padding: 0;
    margin: 0;
    background: url(/images/block-title-left-messages.png) no-repeat left top;
}
.indexhead div.content p {
    font-size: 85%;
    margin: 0;
    padding: 0.3em 1.5em;
    color: #000;
...
.indexhead div.content a {
    color: #036;
}
.indexhead div.content a:visited {
    color: #6a6a6a;
}
...
div.tags div.tagtitleopen {
    color: #fff;
    background: url(//images.barrapunto.com/block-title-right.png) no-repeat top right;
}
...
div.tags div.tagtitleopen span.tagsheader {
    width: 15px;
    background: url(//images.barrapunto.com/block-arrow-expanded.gif) no-repeat 0 50%;
}
div.tags div.tagtitleclosed span.tagsheader {
    width: 15px;
    background: url(//images.barrapunto.com/login-arrow-collapsed.gif) no-repeat 0 50%;
