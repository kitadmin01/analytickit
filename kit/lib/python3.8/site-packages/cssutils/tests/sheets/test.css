...
E[class~='hipster'][thing~='bob']#myid {
    att1: hi;
    foo: bar;
}
E:lang(c)#unique E.hipster#myid {
    att1: hi;
    foo: bar;
}
...
P {
    color: blue;
    font-vendor: any; /* Invalid prop.: font-vendor */
...
IMG {
    background: 'red';
} /* keywords cannot be quoted in CSS2 */
...
P {
    counter-increment: par-num !important;
}
H1 {
...
@media aural {
    BLOCKQUOTE:after {
        content: url('beautiful-music.wav');
    }
}
