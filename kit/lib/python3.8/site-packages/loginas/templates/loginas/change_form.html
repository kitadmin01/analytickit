{% extends "admin/change_form.html" %} {% load i18n %} {% block object-tools-items %} {{ block.super }}
<li>
    <a id="loginas-link" href="#"><i class="icon-user icon-alpha75"></i>{% trans "Log in as user" %}</a>
</li>
