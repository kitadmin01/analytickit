...
hljs.registerLanguage('objectivec', function (e) {
    ...
    return {
        ...
        c: [
            ...
            { cN: 'class', b: '(' + n.split(' ').join('|') + ')\\b', e: '({|$)', eE: !0, k: n, l: o, c: [e.UTM] },
...
hljs.registerLanguage('scss', function (e) {
    ...
    return {
        ...
        c: [
            ...
            { cN: 'value', b: ':', e: ';', c: [r, i, o, e.CSSNM, e.QSM, e.ASM, { cN: 'important', b: '!important' }] },
            {
                cN: 'at_rule',
                b: '@',
                e: '[{;]',
...
hljs.registerLanguage('haskell', function (e) {
    ...
    return {
        ...
        c: [
            { cN: 'module', b: '\\bmodule\\b', e: 'where', k: 'module where', c: [t].concat(c), i: '\\W\\.|;' },
            {
                cN: 'import',
                b: '\\bimport\\b',
                e: '$',
...
hljs.registerLanguage('profile', function (e) {
    return {
        c: [
            ...
            { cN: 'header', b: '(ncalls|tottime|cumtime)', e: '$', k: 'ncalls tottime|10 cumtime|10 filename', r: 10 },
...
hljs.registerLanguage('java', function (e) {
    ...
    return {
        ...
        i: /<\//,
        c: [
            { cN: 'javadoc', b: '/\\*\\*', e: '\\*/', r: 0, c: [{ cN: 'javadoctag', b: '(^|\\s)@[A-Za-z]+' }] },
            e.CLCM,
            e.CBCM,
            e.ASM,
            e.QSM,
...
hljs.registerLanguage('livescript', function (e) {
    var t = {
        ...
        c = [
            ...
            { cN: 'pi', v: [{ b: '//', e: '//[gim]*', c: [n, e.HCM] }, { b: /\/(?![ *])(\\\/|.)*?\/[gim]*(?=\W|$)/ }] },
            { cN: 'property', b: '@' + s },
            { b: '``', e: '``', eB: !0, eE: !0, sL: 'javascript' },
        ]
    n.c = c
...
hljs.registerLanguage('stylus', function (t) {
    ...
    return {
        ...
        c: [
            ...
            t.CBCM,
            o,
            { b: '\\.[a-zA-Z][a-zA-Z0-9_-]*' + a, rB: !0, c: [{ cN: 'class', b: '\\.[a-zA-Z][a-zA-Z0-9_-]*' }] },
            { b: '\\#[a-zA-Z][a-zA-Z0-9_-]*' + a, rB: !0, c: [{ cN: 'id', b: '\\#[a-zA-Z][a-zA-Z0-9_-]*' }] },
...
hljs.registerLanguage('x86asm', function (s) {
    return {
        ...
        c: [
            ...
            { cN: 'number', b: '\\b(?:0[HhXx][0-9A-Fa-f_]+|0[DdTt][0-9_]+|0[QqOo][0-7_]+|0[BbYy][0-1_]+)\\b' },
            s.QSM,
            { cN: 'string', b: "'", e: "[^\\\\]'", r: 0 },
            { cN: 'string', b: '`', e: '[^\\\\]`', r: 0 },
...
hljs.registerLanguage('roboconf', function (e) {
    ...
    return {
        ...
        k: 'import',
        c: [
            { cN: 'facet', b: '^facet ' + n, e: '}', k: 'facet installer exports children extends', c: [e.HCM] },
            {
                cN: 'instance-of',
                b: '^instance of ' + n,
                e: '}',
...
hljs.registerLanguage('vala', function (e) {
    return {
        ...
        c: [
            { cN: 'class', bK: 'class interface delegate namespace', e: '{', eE: !0, i: '[^,:\\n\\s\\.]', c: [e.UTM] },
            e.CLCM,
            e.CBCM,
            { cN: 'string', b: '"""', e: '"""', r: 5 },
            e.ASM,
...
hljs.registerLanguage('lasso', function (e) {
    ...
    return {
        ...
        k: s,
        c: [
            { cN: 'preprocessor', b: t, r: 0, starts: { cN: 'markup', e: '\\[|' + a, rE: !0, r: 0, c: [n] } },
            o,
            i,
            {
                cN: 'preprocessor',
...
hljs.registerLanguage('clojure-repl', function (e) {
    return {
        c: [
            { cN: 'prompt', b: /^([\w.-]+|\s*#_)=>/, starts: { e: /$/, sL: 'clojure', subLanguageMode: 'continuous' } },
        ],
    }
})
