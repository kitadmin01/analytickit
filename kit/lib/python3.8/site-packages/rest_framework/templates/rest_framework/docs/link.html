...
<div class="row coredocs-link">
    <div class="col-md-6 docs-content">
        ...
        <h3 id="{{ section_key }}-{{ link_key|slugify }}" class="coredocs-link-title">
            ...
            <a href="#{{ section_key }}-{{ link_key|slugify }}"><i class="fa fa-link" aria-hidden="true"></i> </a>
        </h3>
    ...
    <div class="col-md-6 code-samples">{% for html in lang_htmls %} {% include html %} {% endfor %}</div>
</div>
